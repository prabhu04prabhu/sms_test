<%@ Page Title="Whole Sales Entry" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmSalesEntry.aspx.cs" Inherits="frmSalesEntry" %>
        ...
        <section class="content">
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">Whole Sales Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divCustomer" style="width: 282px;">
                            <label>
                        ...
                        <div class="form-group col-md-6" id="divCustomerAddress">
                            ...
                            <input type="text" class="form-control" id="txtCustomerAddress" placeholder="CustomerAddress"
                                maxlength="1000" tabindex="-1" readonly="true" />
                        </div>
                          <div class="form-group col-md-2" id="divState">
                            <label>
                                State</label><span class="text-danger">*</span>
                            <select id="ddlState" class="form-control select2" data-placeholder="Select State Name" tabindex="5" readonly="true"></select>
                        </div>
                        <div class="form-group col-md-2" id="divTaxName">
                         ...
                         <div class="form-group col-md-2" id="divOrderNo">
                            <label>
                                Order No</label>
                            <input type="text" class="form-control" id="txtOrderNo" placeholder="Order No"
                                maxlength="1000" tabindex="6" />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divTotalTaxAmount">
                            ...
                            <input type="text" class="form-control" id="txtTotalTaxAmount" placeholder="Amount" style="font-size: 104%; font-weight: bold;"
                                maxlength="15" tabindex="18" value="0" autocomplete="off" readonly />
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divOtherCharges">
                            <input type="text" class="form-control" id="txtOtherCharges" placeholder="Other Charges" style="font-size: 104%; font-weight: bold;"
                                maxlength="15" tabindex="19" value="0" autocomplete="off" readonly />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8" id="divIRNNo">
                            <input type="text" class="form-control" id="txtIRNNo" placeholder=" IRN No"
                                maxlength="500" tabindex="20" autocomplete="off" />
                        </div>
                        ...
                        <div class="form-group col-md-2" id="divRoundoff">
                            <input type="text" class="form-control" id="txtRoundoff" placeholder="Roundoff" style="font-size: 104%; font-weight: bold;"
                                maxlength="15" tabindex="23" value="0" autocomplete="off" readonly />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-1">
                        ...
                        <div class="form-group col-md-2" id="divAgent">
                            <select id="ddlAgent" class="form-control select2" data-placeholder="Select Agent Name" tabindex="24"></select>
                        </div>
                        ...
                        <div class="form-group col-md-5" id="divACKno">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divTransportName">
                            <select id="ddlTransport" class="form-control select2" data-placeholder="Select Transport Name" tabindex="26"></select>
                        </div>
                        <div class="form-group col-md-1">
                            <label>
                        ...
                        <div class="form-group col-md-2" id="divVehicleNo">
                            ...
                            <input type="text" class="form-control" id="txtVehicleNo" placeholder=" Vehicle No"
                                maxlength="50" tabindex="27" autocomplete="off" />
                        </div>
                        <div class="form-group col-md-1" style="text-align: right;">
                            <label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divNarration">
                            <input type="text" class="form-control" id="txtNarration" placeholder="Narration"
                                maxlength="500" tabindex="31" autocomplete="off" row/>
                        </div>
                    ...
                    <div class="form-group col-md-12" id="divAddress">
                        <label>
                            Notes</label>
                        <textarea id="txtComments" class="form-control" maxlength="1000" tabindex="33" rows="3" aria-autocomplete="none" style="width: 102%"></textarea>
                    </div>
                    <div class="row">
                ...
                <div class="row" style="display: none" id="divBank">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divCardNo">
                            ...
                            <input type="text" class="form-control" id="txtCardNo" placeholder="CardNo"
                                maxlength="16" tabindex="34" style="width: 192px;" onkeypress="return IsNumeric(event)" autocomplete="off" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-9"></div>
                        ...
                        <div class="form-group col-md-2" id="divCardCharges">
                            ...
                            <input type="text" class="form-control" id="txtCardCharges" placeholder="CardCharges"
                                maxlength="15" tabindex="35" value="0" style="width: 192px;" onkeypress="return IsNumeric(event)" autocomplete="off" />
                        </div>
                    </div>
                    <div class="form-group col-md-9"></div>
                    <div class="form-group col-md-1">
                    ...
                    <div class="form-group col-md-2">
                        <select id="ddlBankName" class="form-control select2" data-placeholder="Select Bank Name" tabindex="36"></select>
                    </div>

                </div>

                <div class="modal-footer clearfix">
                    <button id="btnSave" type="button" class="btn btn-info margin pull-left" tabindex="37">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Save</button>
                    <button id="btnUpdate" type="button" class="btn btn-info margin pull-left" tabindex="38">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Update</button>
                    <button type="button" class="btn btn-danger margin pull-right" id="btnClose" tabindex="39">
                        <i class="fa fa-close"></i>&nbsp;&nbsp;Close</button>
                    <button id="btnPrintbill" type="button" class="btn btn-info btnPrint pull-left" style="margin-top: 10px !important;" tabindex="40">
                        ...
                        <div class="modal-body">
                            <div class="form-group" id="divReason">
                                ...
                                <input type="text" class="form-control" id="txtReason" placeholder="Please enter Reason"
                                    maxlength="150" tabindex="41" />
                            </div>
                            <div class="form-group" id="divPassword">
                                <label>
                                    Password</label><span class="text-danger">*</span>
                                <input type="text" class="form-control" id="txtPassword" placeholder="Please enter Password"
                                    maxlength="150" tabindex="42" autocomplete="off" />
                            </div>
                            <div class="form-group" id="divID">
                                <label>
                                    ID</label><span class="text-danger">*</span>
                                <input type="text" class="form-control" id="txtID"
                                    maxlength="150" tabindex="43" />
                            </div>
                        </div>
                        <div class="modal-footer clearfix">
                            <button type="submit" class="btn btn-info pull-left" id="btnOK" tabindex="44">
                                <i class="fa fa-save"></i>&nbsp;&nbsp;
                                Save</button>
                            <button type="button" class="btn btn-danger pull-right" id="btnCancel" tabindex="45">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix" style="display: none;">
                            <button type="button" class="btn btn-danger pull-left" id="btndetailsCancel" tabindex="46">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="Allcomposedetails" tabindex="-1" role="dialog" aria-hidden="true" style="margin-top: -25px;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="width: 105%;">
                        ...
                        <div class="modal-footer clearfix" style="display: none;">
                            <button type="button" class="btn btn-danger pull-left" id="btnAlldetailsCancel" tabindex="47">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="composeImage" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-danger pull-left" id="btnImageCancel" tabindex="48">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" id="divProduct">
                                    ...
                                    <div id="divSelectProduct">
                                        <select id="ddlProduct" class="form-control select2" data-placeholder="Select Product Name" tabindex="50"></select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4" id="divPurchasePrice">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtPurchasePrice" placeholder="Purchase Price"
                                        maxlength="12" tabindex="51" readonly="true" />
                                </div>
                                <div class="form-group col-md-4" id="divWholeSalePrice">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtWholeSalePrice" placeholder="WholeSale Price"
                                        maxlength="12" tabindex="52" readonly="true" />
                                </div>
                                <div class="form-group col-md-4" id="divRetailPrice">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtRetailPrice" placeholder="Retail Price"
                                        maxlength="12" tabindex="53" readonly="true" />
                                </div>
                                <div class="form-group col-md-4" id="divWholeSalePriceA">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtWholeSalePriceA" placeholder="WholeSale Price A"
                                        maxlength="12" tabindex="54" readonly="true" />
                                </div>
                                <div class="form-group col-md-4" id="divWholeSalePriceB">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtWholeSalePriceB" placeholder="WholeSale Price B"
                                        maxlength="12" tabindex="55" readonly="true" />
                                </div>
                                <div class="form-group col-md-4" id="divWholeSalePriceC">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtWholeSalePriceC" placeholder="WholeSale Price C"
                                        maxlength="12" tabindex="56" readonly="true" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-danger pull-left" id="btnRateCancel" tabindex="57">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="composeProductImage" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-danger pull-left" id="btnProductImageCancel" tabindex="58">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
