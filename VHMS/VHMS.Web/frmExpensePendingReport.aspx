<%@ Page Title="Expense Pending Report" Language="C#" MasterPageFile="~/VHMSReportPage.master"
    AutoEventWireup="true" CodeFile="frmExpensePendingReport.aspx.cs" Inherits="frmExpensePendingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper hidden">
        <div class="content-header">
            <h1>
                Expense Pending Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Expense Pending Report</li>
            </ol>
        </div>
        <div class="content">
                    ...
                    <div class="box box-warning box-solid" id="divFilter">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="Div1" style="display:none">
                                    <label>
