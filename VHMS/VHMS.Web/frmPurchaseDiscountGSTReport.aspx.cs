...
public partial class frmPurchaseDiscountGSTReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PurchaseDiscountGST.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=PurchaseDiscountGST.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintPurchaseDiscountGST(txtDOB.Text, txtDOR.Text, ddluser.Text);
        try
        {
        ...
        {
            sException = "frmPrintPurchaseDiscountGST | " + ex.ToString();
