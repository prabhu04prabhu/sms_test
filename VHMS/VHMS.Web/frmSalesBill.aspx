<%@ Page Title="Sales Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmSalesBill.aspx.cs" Inherits="frmSalesBill" %>
                    ...
                    <div class="box box-warning box-solid" id="divFilter">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-1">
                                    <asp:Button ID="btnprint" Text="print" CausesValidation="false" CssClass="btn btn-info" Style="margin-top: 25PX; height: 30px; width: 60px; padding-top: 4PX;" OnClick="btnPrint_Click" runat="server" />
                                </div>
                    ...
                    <%-- <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Sales Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <%-- <asp:BoundField ItemStyle-Width="130px" HeaderText="InvoiceAmount" ReadOnly="true" DataField="InvoiceAmount" />
