<%@ Page Title="Print Estimate Sales Invoice" Language="C#" MasterPageFile="~/VHMSReportPage.master"
    AutoEventWireup="true" CodeFile="PrintEstimateSalesEntryInvoice.aspx.cs" Inherits="PrintEstimateSalesEntryInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper hidden">
        <div class="content-header">
            <h1>Print Estimate Sales Invoice
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Transaction</a></li>
                <li><a href="#">Sales</a></li>
                <li class="active">Print Estimate Sales Invoice</li>
            </ol>
        </div>
        <div style="margin-left: 25%">
            ...
            <asp:Button ID="btnExportReport" runat="server" Text="Print Report" TabIndex="4"
             ...
             <asp:CheckBox ID="chkPartyCode" runat="server" style="font-size: x-large;" AutoPostBack="true" Text="SMS Code"  OnCheckedChanged="chkPartyCode_CheckedChanged"
                        CssClass="chkBigCheckBox    " />
        </div>
