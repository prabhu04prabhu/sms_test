...
public partial class frmExpensePaymentReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ExpensePaymentReports.xls");
            Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=ExpensePaymentReports.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintExpensePaymentReport(txtDOB.Text, txtDOR.Text, ddlSupplier.SelectedValue, ddluser.SelectedValue);
        try
        {
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            InvoiceAmount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "OtherDiscount"));
