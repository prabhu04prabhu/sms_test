<%@ Page Title="LREntry Reports" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmLREntryReports.aspx.cs" Inherits="frmLREntryReports" %>
    ...
    <div class="container-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">LR Entry Reports</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="LR Entry Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_LREntryID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="LREntry No" ReadOnly="true" DataField="LREntryNo" />
                                <asp:BoundField HeaderText="LREntry Date" ReadOnly="true" DataField="LREntryDate" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:BoundField HeaderText="Transport Name" ReadOnly="true" DataField="TransportName" />
