<%@ Page Title="Print Estimate Retail sales Invoice" Language="C#" MasterPageFile="~/VHMSReportPage.master" AutoEventWireup="true" CodeFile="PrintEstimateRetailsalesEntry.aspx.cs" Inherits="PrintEstimateRetailsalesEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper hidden">
        <div class="content-header">
            <h1>Print Estimate Retail sales Invoice
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Transaction</a></li>
                <li><a href="#">Sales</a></li>
                <li class="active">Print Estimate Retail sales Invoice</li>
            </ol>
        </div>
        <div style="margin-left: 25%">
           ...
           <div class="form-group col-md-2" style="margin-top: -24px;">
               ...
               <asp:DropDownList ID="ddluser" runat="server" AutoPostBack="true" data-placeholder="Select User"  OnTextChanged="ddlPayment_SelectedIndexChanged"
                   ...
                   <asp:ListItem Value="EstimateMEMO" Text="EstimateMEMO"></asp:ListItem>
