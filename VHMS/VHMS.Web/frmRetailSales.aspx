<%@ Page Title="Retail Sales" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmRetailSales.aspx.cs" Inherits="frmRetailSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    <div class="container-wrapper hidden">
        <section class="content-header" id="secHeader">
            <div id="divTitle">
                ...
                <div class="form-group  col-md-4" style="margin-left: 255px; margin-top: -64px;">
                    <label>
                        Customer Name</label>
                    <select id="ddlCustomer" class="form-control select2" data-placeholder="Select Category Name" tabindex="-1"></select>
                </div>
            </div>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divNarration">
                            ...
                            <input type="text" class="form-control" id="txtNarration" placeholder="Narration"
                                maxlength="1000" tabindex="29" autocomplete="off" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8" id="divComments">
                            <label>
                                Comments</label>
                            <textarea id="txtComments" class="form-control" maxlength="5000" tabindex="43" rows="7" aria-autocomplete="none" style="width: 152%"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix">
                            <button type="submit" class="btn btn-info pull-left" id="btnOK" tabindex="51">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" id="divSearchCode">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtSearchCode" placeholder="Code"
                                        maxlength="12" tabindex="55" autocomplete="off" />
                                </div>
    ...
    <input type="hidden" id="hdnRetailSalesID" />
    ...
    <input type="hidden" id="hdnReceiptPaidAmount" />
    <input type="hidden" id="hdnOPOrderID" />
    <input type="hidden" id="hdnLastinvoiceDate" />
    <input type="hidden" id="hdnSalesID" />
    <script src="UserDefined_Js/jRetailSales.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jRetailSales.js") %>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        document.onkeydown = function () {
            ...
            if (event.keyCode == 67 && event.altKey) {
                $(".modal-backdrop").hide();
                GetProductDetails($("#ddlProductName").val(), 0, $("#hdnCustomerID").val(), $("#txtCode").val());
            ...
            if (event.keyCode == 86 && event.altKey) {
                if ($("#ddlProductName").val() > 0) {
                    $(".modal-backdrop").hide();
                    if ($("#txtCode").val() != "")
                        GetProductDetails($("#ddlProductName").val(), 2, $("#ddlCustomerName").val(), $("#txtCode").val());
