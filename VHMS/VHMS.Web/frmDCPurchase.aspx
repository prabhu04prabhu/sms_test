<%@ Page Title="DCPurchase" Language="C#" MasterPageFile="~/VHMSMasterPage.master"
    AutoEventWireup="true" CodeFile="frmDCPurchase.aspx.cs" Inherits="frmDCPurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
                        ...
                        <div class="box box-warning">
                            <div class="box-body">
                                <div class="form-group" id="divSearchaname">
                                    <label>
                                        Search DCPurchase records</label><span class="text-danger">*</span>
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">DCPurchase Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-1" id="divBillNo">
                            <input type="text" class="form-control" id="txtBillNo" placeholder="DCPurchase No"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-1">
                            <label>
                                <input type="checkbox" id="chkYarn" tabindex="-1" />&nbsp;&nbsp;&nbsp; Yarn
                            </label>
                        </div>
                        <div class="form-group col-md-1">
                            <label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <button id="btnClearImage1" type="button" style="margin-top: -11px; color: deeppink;" class="btn btn-link">
                                Clear</button>
                            <input name="imageDCPurchasefile" type="file" id="imageDCPurchasefile" data-image-src="imgUploadDCPurchase1_view" accept="image/*" onchange="ResizeImage('imageDCPurchasefile');" />
                            <a href="#" data-fancybox="images">
                                <img src="" id="imgUploadDCPurchase1_view" class="preview_img" alt="" style="width: 280px;" />
                            </a>
                        </div>
                        <div class="form-group col-md-4">
                            <label>
                            ...
                            <button id="btnClearImage2" type="button" style="margin-top: -11px; color: deeppink;" class="btn btn-link">
                                Clear</button>
                            <input name="imageDCPurchasefile" type="file" id="imageDCPurchasefile2" data-image-src="imgUploadDCPurchase2_view" accept="image/*" onchange="ResizeImage('imageDCPurchasefile2');" />
                            <a href="#" data-fancybox="images">
                                <img src="" id="imgUploadDCPurchase2_view" alt="" class="preview_img" style="width: 280px;" />
                            </a>
                        </div>
                        <div class="form-group col-md-4">
                            <label>
                            ...
                            <button id="btnClearImage3" type="button" style="margin-top: -11px; color: deeppink;" class="btn btn-link">
                                Clear</button>
                            <input name="imageDCPurchasefile" type="file" id="imageDCPurchasefile3" data-image-src="imgUploadDCPurchase3_view" accept="image/*" onchange="ResizeImage('imageDCPurchasefile3');" />
                            <a href="#" data-fancybox="images">
                                <img src="" id="imgUploadDCPurchase3_view" alt="" class="preview_img" style="width: 280px;" />
                            </a>
                        </div>
                    ...
                    <div class="modal-footer clearfix">
                        ...
                        <button id="btnDCPurchaseBarcode" type="button" class="btn btn-info pull-left" tabindex="26">
            ...
            <div class="modal fade" id="composeProductImage" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                 ...
                 <div class="modal fade" id="composedialogStock" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-titleStock" style="text-align: center"></h4>
                        </div>
                        <div class="modal-footer clearfix" style="text-align: center">
                            <button type="button" class="btn btn-warning" id="btnCloseDialogStock" tabindex="33">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                OK</button>
                        </div>
                    </div>
    ...
    <input type="hidden" id="hdnDCPurchaseID" />
    <input type="hidden" id="hdnDCPurcID" />
    <input type="hidden" id="hdnDCPurchaseTransID" />
    ...
    <script src="UserDefined_Js/jDCPurchase.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jDCPurchase.js") %>"
    ...
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmDCPurchase.aspx") %>';
        ...
        function DocumentuploadComplete(sender, args) {
            $.ajax({
                ...
                success: function (r) {
                    ...
                    $get("imgUpload1").src = "./images/Documents/DCPurchase/" + r.d;
                },
                failure: function (response) {
                    alert(response.d);
                }
    ...
    <script type="text/javascript">
        document.onkeydown = function () {
            if (event.keyCode == 113) {
                var myWindow = window.open("frmDDCPurchase.aspx", "_self");
            }
