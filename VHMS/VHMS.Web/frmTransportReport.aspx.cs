...
public partial class frmTransportReport : System.Web.UI.Page
{
    ...
    //{
    //    Collection<VHMS.Entity.Supplier> ObjList = new Collection<VHMS.Entity.Supplier>();
    //    ObjList = VHMS.DataAccess.Supplier.GetSupplier();
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintTransport();
        try
        {
            if (dsData.Tables.Count > 0)
            {
                dsData.Tables[0].TableName = "tTransport";
        ...
        {
            sException = "frmPrintTransport | " + ex.ToString();
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=Transport.xls");
