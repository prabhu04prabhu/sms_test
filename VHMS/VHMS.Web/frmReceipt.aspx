...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    <div class="container-wrapper hidden">
        ...
        <section class="content">
            ...
            <div class="modal fade" id="compose-modal" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialogue modal-dialog-scrollable">
    ...
    <script type="text/javascript">
        ...
        $("#btnAddNew").click(function () {
            ...
            $("#chkAddOnAccount").attr("disabled", false);
        ...
        $("#btnSave,#btnUpdate").click(function () {
            ...
            if (iTotCount == 1) {
                ...
                if ($("#chkAddOnAccount").prop('checked') == true)
                    iPaidAmount = (parseFloat($("#txtAmount").val()) + parseFloat($("#txtDiscountAmount").val()) + parseFloat($("#txtOnAccount").val()) - parseFloat($("#txtTDSAmount").val()))
                else
                    iPaidAmount = (parseFloat($("#txtAmount").val()) + parseFloat($("#txtDiscountAmount").val()) - parseFloat($("#txtTDSAmount").val()))

                if (Balance < iPaidAmount) {
                ...
                if (parseFloat($("#txtBalanceAmount").val()) + parseFloat($("#hdnAmount").val()) < parseFloat($("#txtAmount").val())) {
        ...
        function CalculateTrans() {
            ...
            if (Amount < iAmount)
                $("#txtPendingAmount").val(parseFloat(iAmount - Amount).toFixed(2));
            else if (Amount == iAmount) {
                var Balance_Amt = 0;
                $("#txtPendingAmount").val(parseFloat(Balance_Amt).toFixed(2));
            }
            else {
                if ($("#chkAddOnAccount").prop('checked') == true)
        ...
        function DisplayPendingBillList(gData) {
            ...
            if (gData.length > 0) {
                ...
                sTable += "<th class='" + sColorCode + "'>Sales.Disc</th>";
                ...
                for (var i = 0; i < gData.length; i++) {
                    ...
                    sTable += "<td>" + gData[i].TDSPayment + "</td>";
                    sTable += "<td>" + gData[i].SalesDiscountAmount + "</td>";
                        ...
                        if (objResponse.Status == "Success") {
                            if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                                ...
                                if (obj != null) {
                                    ...
                                    $("#ddlBank").val(obj.ReceiptBank.LedgerID).change();
                                }
                                dProgress(false);
                            }
                            else if (objResponse.Value == "NoRecord") {
                            ...
                            if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                                ...
                                if (obj.length > 0) {
                                    ...
                                    for (var index = 0; index < obj.length; index++) {
                                        ...
                                        var result1 = result.split('.00').join('');
                                        ...
                                        table += "<td class='hidden-xs'>" + result2 + "</td>";
                        ...
                        if (objResponse.Status == "Success") {
                            if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                                ...
                                if (obj != null) {
                                    ...
                                    $("#chkAddOnAccount").attr("disabled", true);
                                    ...
                                    $("#hdnAmount").val(obj.Amount + obj.DiscountAmount);
                                    $("[id*=imgUpload1]").attr("src", obj.DocumentPath);
