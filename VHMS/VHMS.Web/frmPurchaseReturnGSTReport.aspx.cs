...
public partial class frmPurchaseReturnGSTReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PurchaseReturnGST.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=PurchaseReturnGST.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintPurchaseReturnGST(txtDOB.Text, txtDOR.Text, ddluser.Text);
        try
        {
        ...
        {
            sException = "frmPrintPurchaseReturnGST | " + ex.ToString();
