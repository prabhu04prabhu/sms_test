<%@ Page Title="Estimate Whole Sales Entry" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmEstimateSalesEntry.aspx.cs" Inherits="frmEstimateSalesEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
                        ...
                        <div class="box box-warning">
                            <div class="box-body">
                                <div class="form-group" id="divSearchaname">
                                    <label>
                                        Search Whole EstimateSales records</label><span class="text-danger">*</span>
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">Estimate Whole Sales Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6" id="divAddres">
                            <label>
                    ...
                    <div class="row" style="display: none;">
                        ...
                        <div class="form-group col-md-2" id="divTransportGSTNo" style="display: none;">
                            <input type="text" class="form-control" id="txtTransportGSTNo" placeholder="Transport GSTNo"
                                maxlength="50" tabindex="-1" autocomplete="off" readonly />
                        </div>
                        ...
                        <div class="form-group col-md-1" style="text-align: right; display: none;">
                            <label>
                                Transport Charges</label>
                        </div>
                        <div class="form-group col-md-2" id="divTransportCharge" style="display: none;">
                    ...
                    <div class="form-group col-md-12" id="divAddress">
                        <label>
                            Notes</label>
                        <textarea id="txtComments" class="form-control" maxlength="1000" tabindex="23" rows="3" aria-autocomplete="none" style="width: 101%"></textarea>
                    </div>
                    <div class="row" style="display: none;">
                ...
                <div class="modal-footer clearfix">
                    ...
                    <button id="btnConvert" type="button" class="btn btn-info margin pull-left" tabindex="28">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Convert to Wholesale Bill</button>
    ...
    <input type="hidden" id="hdnEstimateSalesID" />
    ...
    <input type="hidden" id="hdnEstimateSalesLimit" />
    <input type="hidden" id="hdnCustomerBalanceAmount" />
    <input type="hidden" id="hdnEstimateSalesDiscountPercent" />
    ...
    <input type="hidden" id="hdnConvertBill" />
    <input type="hidden" id="hdnOPSNo" />
    <input type="hidden" id="hdnOPOrderID" />
    <input type="hidden" id="hdnviewmargin" />
    <input type="hidden" id="hdnCustomerID" />
    <script src="UserDefined_Js/jEstimateSalesEntry.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jEstimateSalesEntry.js") %>" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmEstimateSalesEntry.aspx") %>';
    ...
    <script type="text/javascript">
        document.onkeydown = function () {
            if (event.keyCode == 67 && event.altKey) {
                ...
                $(".modal-backdrop").hide();
                console.log($('#hdnIsAllProduct').val());
                if ($("#ddlProductName").val() > 0) {
                    if ($("#txtCode").val() != "")
                        GetEstimateSalesProductDetails($("#ddlProductName").val(), $("#txtCode").val(), 0, $("#hdnCustomerID").val());
                    else
                        GetEstimateSalesProductDetails($("#ddlProductName").val(), $("#hdnSMSCode").val(), 0, $("#hdnCustomerID").val());
            ...
            if (event.keyCode == 86 && event.altKey) {
                ...
                if ($("#ddlProductName").val() > 0) {
                    if ($("#txtCode").val() != "")
                        GetAllProductDetails($("#ddlProductName").val(), $("#txtCode").val(), 1, $("#hdnCustomerID").val());
                    else
                        GetAllProductDetails($("#ddlProductName").val(), $("#hdnSMSCode").val(), 1, $("#hdnCustomerID").val());
                }
            }
