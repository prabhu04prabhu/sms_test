<%@ Page Title="Purchase Bill Ledger Report" Language="C#" AutoEventWireup="true" MasterPageFile="~/VHMSReportPage.master" CodeFile="frmPurchaseBillLegder.aspx.cs" Inherits="frmPurchaseBillLegder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Purchase Bill Ledger Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Purchase Bill Ledger Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Purchase Bill Ledger Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_PurchaseID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="PurchaseNo" ReadOnly="true" DataField="PurchaseNo" />
                                <asp:BoundField HeaderText="Entry Date" ReadOnly="true" DataField="PurchaseDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="BillNo" ReadOnly="true" DataField="BillNo" />
                                <asp:BoundField HeaderText="BillDate" ReadOnly="true" DataField="BillDate" DataFormatString="{0:dd/MM/yyyy}" />
                    ...
                    <%--              <asp:BoundField HeaderText="TDS" ReadOnly="true" DataField="TDSAmount" />--%>
                                <asp:BoundField HeaderText="Net Amount" ReadOnly="true" DataField="NetAmount" />
                                <%-- <asp:BoundField HeaderText="Paid Amount" ReadOnly="true" DataField="TotalPaidAmount" />--%>

                                <asp:TemplateField HeaderText="Return Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalReturnCount" runat="server"></asp:Label>
                                        <br />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Pur.Disc Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalPurDiscAmount" runat="server"></asp:Label>
                                        <br />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="Total Amount" ReadOnly="true" DataField="BalanceTotalAmount" />
                                <asp:TemplateField HeaderText="Paid Amount">
                                    ...
                                    <asp:BoundField HeaderText="Discount_Amount" ReadOnly="true" DataField="Discount_Amount" />
                                <asp:BoundField HeaderText="Other Charges" ReadOnly="true" DataField="OtherDiscount" />
                                <%-- <asp:BoundField HeaderText="Return Amount" ReadOnly="true" DataField="TotalReturnAmount" />--%>
                                <asp:BoundField HeaderText="Balance Amount" ReadOnly="true" DataField="BalanceAmount" />
