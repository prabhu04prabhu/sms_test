<%@ Page Title="PunchLog Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPunchLogReport.aspx.cs" Inherits="frmPunchLogReport" %>
    ...
    <div class="container-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">PunchLog Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    <div class="box box-warning box-solid" id="divFilter">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="Employee">
                                    <label>
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="PunchLog Report" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="FK_EmployeeID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="IN Time" ReadOnly="true" DataField="Intime" />
                                 <asp:BoundField HeaderText="Out Time" ReadOnly="true" DataField="Outtime" />
                            </Columns>
