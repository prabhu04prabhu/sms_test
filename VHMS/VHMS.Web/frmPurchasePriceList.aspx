<%@ Page Title="Purchase Price List" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPurchasePriceList.aspx.cs" Inherits="frmPurchasePriceList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
            ...
            <div class="row" id="divRecords" runat="server">
                <div class="col-xs-12">
                    ...
                    <div class="modal-footer clearfix">
                        <button id="btnSave" type="button" class="btn btn-info margin pull-left hide" tabindex="20">
    ...
    <script src="UserDefined_Js/Billing/JPurchasePriceList.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/Billing/JPurchasePriceList.js") %>" type="text/javascript"></script>
