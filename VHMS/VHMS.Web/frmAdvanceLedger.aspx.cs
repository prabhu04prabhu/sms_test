...
public partial class frmAdvanceLedger : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=AdvanceLedger.xls");
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                dsData = VHMS.DataAccess.VHMSReports.PrintAdvanceLedgerReport(txtDOB.Text, txtDOR.Text);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=AdvanceLedger.pdf");
        ...
        try
        {
            ...
            if (ddluser.Text == "Detailed")
            {
                    string TableHTML = ""; string CompanyName = "";        
                        ...
                        TableHTML += "<table cellpadding='0' cellspacing='0' ><thead><tr><th  style='text-align:center;'Colspan='5'>Advance Ledger</th></tr></thead></table>";
