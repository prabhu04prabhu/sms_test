...
public partial class frmOtherExpenseReport : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintOtherExpenseReport(txtDOB.Text, txtDOR.Text, ddlCustomer.SelectedValue);
        try
        {
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=OtherExpenseReport.pdf");
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            ReturnAmount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "CreditAmount"));
        }
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AppendHeader("content-disposition", "attachment; filename=OtherExpenseReport.xls");
