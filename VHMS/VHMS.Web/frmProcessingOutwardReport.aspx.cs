...
public partial class frmProcessingOutwardReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProcessingInwardReports.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ProcessingInwardReports.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintProcessingOutwardReport(txtDOB.Text, txtDOR.Text, ddlProduct.SelectedValue, ddlCategory.SelectedValue, ddlSubCategory.SelectedValue, ddlVendor.SelectedValue);
        try
        {
            if (dsData.Tables.Count > 0)
            {
                dsData.Tables[0].TableName = "tProcessingOutwardTrans";
