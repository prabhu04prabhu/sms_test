        ...
        try
        {
            ...
            if (dsReportData.tSupplier.Rows.Count > 0)
            {
                ...
                foreach (ReportDataSet.tSupplierRow drtJobCardRow in dsReportData.tSupplier)
                {
                        ...
                        TableHTML += "<tr><th style='width:20%;'><b> Date</b></th><th style='width:35%;'><b>Particulars</b></th></th><th style='width:15%;text-align:right'><b>Credit</b></th><th style='width:15%;text-align:right'><b>Debit</b></th><th style='width:15%;text-align:right'><b>Balance</b></th></tr></thead>";
