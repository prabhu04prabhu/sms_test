...
public partial class frmSalesDiscountReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SalesDiscountReports.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=SalesDiscountReports.pdf");
    ...
    private void LoadReport()
    {
     ...
     dsData = VHMS.DataAccess.VHMSReports.PrintSalesDiscount(txtDOB.Text, txtDOR.Text, 0, ddlCustomer.SelectedValue);
        try
        {
        ...
        {
            sException = "frmPrintSalesDiscount| " + ex.ToString();
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
           ...
           InvoiceAmount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TotalAmount"));
