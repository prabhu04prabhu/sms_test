<%@ Page Title="Estimate Retail Sales" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmEstimateRetailSales.aspx.cs" Inherits="frmEstimateRetailSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
                                    ...
                                    <table id="tblRecord" class="table table-striped table-bordered bg-info" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Total Qty</th>
                                                <th>Net Amount</th>
                                                <th class="displayMargin">Margin %</th>
                                                <th>Status</th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">Estimate Retail Sales Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-1" id="divchkExchange" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divNetAmount">
                            <input type="text" class="form-control" id="txtNetAmount" placeholder="Net Amount" style="font-weight: bold; font-size: 20px;"
                                maxlength="255" tabindex="-1" readonly="true" value="0" onkeypress="return IsNumeric(event)" />
                        </div>
                        <%--  <div class="form-group col-md-1">
                            <label>
                                Narration</label>
                        ...
                        <div class="form-group col-md-2" id="divNarration">
                            ...
                            <textarea class="form-control" id="txtNarration" placeholder="Narration"
                                maxlength="50" tabindex="29" rows="3" aria-autocomplete="none" ></textarea>
                        </div>--%>
                        <div class="form-group col-md-4" id="divNarration">
                            <label>
                                Narration</label>
                            <textarea id="txtNarration" class="form-control" maxlength="1000" tabindex="22" rows="3" aria-autocomplete="none" style="width: 315%"></textarea>
                        </div>
                    ...
                    <div class="box box-primary box-solid" id="divPayment" style="display: none;">
                        <div class="box-header">
                            Payment mode
                        </div>
                        <div class="box-body">
                ...
                <div class="modal-footer clearfix">
                    ...
                    <button id="btnConvert" type="button" class="btn btn-info margin pull-left" tabindex="42">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Convert to Retail Bill</button>
    ...
    <input type="hidden" id="hdnEstimateSalesEntryID" />
    <input type="hidden" id="hdnEstimateSalesEntryTransID" />
    <input type="hidden" id="hdnERetailSalesID" />
    ...
    <input type="hidden" id="hdnSalesConverted" />
    ...
    <input type="hidden" id="hdnviewmargin" />
    <input type="hidden" id="hdnOPOrderID" />
    <script src="UserDefined_Js/jEstimateRetailSales.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jEstimateRetailSales.js") %>" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmEstimateRetailSales.aspx") %>';
