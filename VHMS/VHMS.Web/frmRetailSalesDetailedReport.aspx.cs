...
public partial class frmRetailSalesDetailedReport : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintRetailsSalesEntry(0, txtDOB.Text, txtDOR.Text, ddlCustomer.SelectedValue, ddlPaymentMode.SelectedValue);
        try
        {
            if (dsData.Tables.Count > 0)
            {
                ...
                foreach (DataRow drow in dsData.Tables[0].Rows)
                    dsReportData.tRetailPaymentMode.ImportRow(drow);
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            InvoiceAmount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Amount"));
        }
