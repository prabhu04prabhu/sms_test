<%@ Page Title="Sales Bill Ledger Report" Language="C#" AutoEventWireup="true" MasterPageFile="~/VHMSReportPage.master" CodeFile="frmSalesBillLegder.aspx.cs" Inherits="frmSalesBillLegder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Sales Bill Ledger Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Sales Bill Ledger Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Sales Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                             ...
                             <asp:BoundField HeaderText="Invoice Date" ReadOnly="true" DataField="InvoiceDate" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:TemplateField HeaderText="Return Amount">
                                  ...
                                  <asp:TemplateField HeaderText="Sales.Disc Amount">
                                    <ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="TDS Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalTDSCount" runat="server"></asp:Label>
                                        <br />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <%--<asp:BoundField HeaderText="TDS Amount" ReadOnly="true" DataField="TDSPaidAmount" />--%>
                                ...
                                <asp:BoundField HeaderText="On Account" ReadOnly="true" DataField="OnAccount" />
    ...
    <script type="text/javascript">
        document.onkeydown = function () {
            if (event.keyCode == 113) {
                var myWindow = window.open("frmDSalesReport.aspx", "_self");
            }
