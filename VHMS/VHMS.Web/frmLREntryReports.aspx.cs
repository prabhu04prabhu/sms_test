...
public partial class frmLREntryReports : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=LREntryReports.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=LREntryReports.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintLREntryReport(txtDOB.Text, txtDOR.Text);
        try
        {
            if (dsData.Tables.Count > 0)
            {
                dsData.Tables[0].TableName = "tLREntry";
