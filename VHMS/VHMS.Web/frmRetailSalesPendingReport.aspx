<%@ Page Title="Retail Sales Pending Report" Language="C#" MasterPageFile="~/VHMSReportPage.master"
    AutoEventWireup="true" CodeFile="frmRetailSalesPendingReport.aspx.cs" Inherits="frmRetailSalesPendingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper hidden">
        <div class="content-header">
            <h1>Retail Sales Pending Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Retail Sales Pending Report</li>
            </ol>
        </div>
        <div class="content">
