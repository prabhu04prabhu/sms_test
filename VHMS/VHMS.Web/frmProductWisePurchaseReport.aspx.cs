...
public partial class frmProductWisePurchaseReport : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintProductWisePurchaseReport(txtDOB.Text, txtDOR.Text, ddlProduct.SelectedValue, ddlCategory.SelectedValue, ddlSubCategory.SelectedValue, ddlSupplier.SelectedValue);
        try
        {
