...
public partial class frmProductWisePurchaseReturnReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProductWisePurchaseReturnReports.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ProductWisePurchaseReturnReports.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintProductWisePurchaseReturnReport(txtDOB.Text, txtDOR.Text, ddlProduct.SelectedValue, ddlCategory.SelectedValue, ddlSubCategory.SelectedValue, ddlSupplier.SelectedValue);
        try
        {
