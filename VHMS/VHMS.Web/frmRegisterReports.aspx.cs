...
public partial class frmRegisterReports : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        if (empid != null && Convert.ToInt32(empid) > 0)
        {
            ...
            Response.Redirect("frmPrintRegister.aspx?mobileview=yes&id=10");
        }
       else{
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintRegister(txtDOB.Text, txtDOR.Text, txtMobile.Text, ddlScheme.SelectedValue, ddlBranch.SelectedValue, ddlEmployeeCode.SelectedValue, RegionID,ZoneID);
        try
        {
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            VHMS.Entity.Billing.Register ObjList = new VHMS.Entity.Billing.Register();
            ObjList = VHMS.DataAccess.Billing.Register.GetRegisterByNo(e.Row.Cells[3].Text, "All", 0,0);
            
            e.Row.Cells[3].Attributes.Add("onClick", "SetSessionValue('RegisterID', " + ObjList.RegisterID + ");SetSessionValue('isView', 'View');window.open('frmRegister.aspx', '_self');");
        }
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[5].Text = Convert.ToDecimal(InstallmentAmount).ToString();
