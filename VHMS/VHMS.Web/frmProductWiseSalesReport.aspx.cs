...
public partial class frmProductWiseSalesReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProductwiseSalesReport.xls");
                Response.Charset = "";
        ...
        {
            //throw exe;
            ExceptionLogging.SendErrorToText(exe);
            exe.ToString();
            //sException = "frmPrintSales | " + exe.ToString();
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProductwiseSalesReport.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintProductWiseSalesReport(txtDOB.Text, txtDOR.Text, ddlProduct.SelectedValue, ddlCategory.SelectedValue, ddlSubCategory.SelectedValue, ddlSupplier.SelectedValue, ddlCustomer.SelectedValue, ddlPaymentMode.SelectedValue,ddlProductType.SelectedValue);
