<%@ Page Title="Purchase Discount GST" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPurchaseDiscountGSTReport.aspx.cs" Inherits="frmPurchaseDiscountGSTReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Purchase Discount GST
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Purchase Discount GST</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Purchase Discount GST Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                ...
                <%--                <asp:BoundField HeaderText="D/C Note" ReadOnly="true" DataField="DCNote" />--%>
                                ...
                                <asp:BoundField HeaderText="GSTIN" ReadOnly="true" DataField="GSTIN" />
                                 <asp:BoundField HeaderText="Entry Date" ReadOnly="true" DataField="EntryDate" DataFormatString="{0:dd/MM/yyyy}"/>
                                ...
                                <asp:BoundField HeaderText="Inv.No" ReadOnly="true" DataField="InvoiceNo" />
                                <asp:BoundField HeaderText="Inv.Date" ReadOnly="true" DataField="InvoiceDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Ret.Value A.Tax" ReadOnly="true" DataField="InvoiceValue" />
