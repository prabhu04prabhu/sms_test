...
public partial class frmPurchasePendingReport : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        try
        {
            ...
            rprt.Load(Server.MapPath("~/Reports/rptPurchasePendingReportGroupWise.rpt"));
    ...
    private ReportDatestNew LoadData()
    {
        ...
        //else
        dsData = VHMS.DataAccess.VHMSReports.PrintPurchasePending(txtDueDays.Text, ddlCustomer.SelectedValue);
        ReportDatestNew dsReportData = new ReportDatestNew();
