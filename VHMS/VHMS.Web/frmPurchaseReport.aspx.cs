...
public partial class frmPurchaseReport : System.Web.UI.Page
{
    ...
    decimal InvoiceAmount = 0, NetAmount = 0, DiscountAmount = 0, TotalQty = 0,TotalAmount=0, Invoice=0, Amount = 0;
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintPurchaseReport(txtDOB.Text, txtDOR.Text, 0, ddlSupplier.SelectedValue, 1, ddluser.Text, dllReportType.Text);
        try
        {
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Amount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TotalAmount"));
            InvoiceAmount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "InvoiceAmount"));
            Invoice += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "Taxablevalue"));
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[6].Text = Convert.ToDecimal(Invoice).ToString();
            e.Row.Cells[7].Text = Convert.ToDecimal(NetAmount).ToString();
