...
public partial class frmRetailsCustomerLedger : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=RetailCustomerLedger.xls");
            ...
            if (ddluser.Text == "Detailed")
            {
                ...
                if (dsReportData.tCustomer.Rows.Count > 0)
                {
                    ...
                    foreach (ReportDataSet.tCustomerRow drtJobCardRow in dsReportData.tCustomer)
                    {
                        ...
                        TableHTML += "<table cellpadding='0' cellspacing='0' ><thead><tr><th  style='text-align:center;'colspan='5'>Customer Ledger</th></tr></thead></table>";
                        ...
                        TableHTML += "<tr><td colspan='5'> " + drtJobCardRow.Address + "</td><td></td></tr>";
                        TableHTML += "<br/>";
                        TableHTML += "</thead></table>";
                        TableHTML += "<table cellpadding='0' cellspacing='0' class='border_details' ><thead>";
                        TableHTML += "<tr><th style='width:15%;'><b> Date</b></th><th style='width:35%;'><b>Particulars</b></th></th><th style='width:20%;text-align:right'><b>Debit(Rs.)</b></th><th style='width:20%;text-align:right'><b>Credit(Rs.)</b></th><th style='width:15%;text-align:right'><b>Balance</b></th></tr></thead>";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.ContentType = "application/pdf";
            Response.AddHeader("content-disposition", "attachment;filename=RetailCustomerLedger.pdf");
            Response.Cache.SetCacheability(HttpCacheability.NoCache);
            StringWriter stringWriter = new StringWriter();
            HtmlTextWriter htmlTextWriter = new HtmlTextWriter(stringWriter);
            divPdf.RenderControl(htmlTextWriter);
