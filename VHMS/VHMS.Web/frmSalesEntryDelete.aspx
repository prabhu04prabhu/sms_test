<%@ Page Title="Whole Sales Entry Delete List" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmSalesEntryDelete.aspx.cs" Inherits="frmSalesEntryDelete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    <div class="container-wrapper hidden">
        <section class="content-header" id="secHeader">
            <div id="divTitle">
                <h3>Whole Sales Entry Delete List
                </h3>
            </div>
    ...
    <script src="UserDefined_Js/jSalesEntryDelete.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jSalesEntryDelete.js") %>" type="text/javascript"></script>
