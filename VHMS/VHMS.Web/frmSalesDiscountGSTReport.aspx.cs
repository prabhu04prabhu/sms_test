...
public partial class frmSalesDiscountGSTReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=WholeSalesDiscountGST.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=WholeSalesDiscountGST.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintSalesDiscountGST(txtDOB.Text, txtDOR.Text, ddluser.Text);
        try
        {
        ...
        {
            sException = "frmPrintSalesReturnGST | " + ex.ToString();
