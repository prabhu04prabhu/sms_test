<%@ Page Title="Retail Sales Return" Language="C#" MasterPageFile="~/VHMSMasterPage.master"
    AutoEventWireup="true" CodeFile="frmRetailSalesReturn.aspx.cs" Inherits="frmRetailSalesReturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
            ...
            <div class="box box-primary" id="divSalesReturn">
                <div class="box-header with-border">
                    <div class="box-title">Retail SalesReturn Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-2" id="divReturnNo">
                            ...
                            <input type="text" class="form-control" id="txtReturnNo" placeholder="RS Return No"
                                maxlength="15" tabindex="-1" readonly="true" />
                        </div>
                        <div class="form-group col-md-2" id="divReturnDate">
                            <label>
                                RS Return Date</label><span class="text-danger">*</span>
                        ...
                        <div class="form-group col-md-2" id="divBillNo" style="display: none;">
                            <label>Debit note #</label>
                            <input type="text" class="form-control" id="txtBillNo" placeholder="Debit note #" maxlength="30" tabindex="-1" />
                        </div>
                        <div class="form-group col-md-2" id="divBillDate" style="display: none;">
                        ...
                        <div class="form-group col-md-2" id="divCustomer">
                            ...
                            <select id="ddlCustomerName" class="form-control select2" data-placeholder="Select Customer Name" tabindex="-1" disabled="disabled"></select>
                        </div>
                     
                        <div class="form-group col-md-2" id="divOldInvoiceNo">
                            <label>
                        ...
                        <div class="form-group col-md-2" id="divtax">
                            ...
                            <select id="ddlTax" class="form-control select2" data-placeholder="Select Tax" tabindex="2">
                            </select>
                        </div>
                    </div>
                    <div class="box box-primary box-solid">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divCode" style="display: none;">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtCode" placeholder="Code"
                                        maxlength="12" tabindex="-1" autocomplete="off" />
                                </div>
                            ...
                            <input type="text" class="form-control" id="txtInvoiceNo" placeholder=""
                                ...
                                <div class="form-group col-md-2" id="divTaxTrans">
                                    <label>
                                        Tax</label><span class="text-danger">*</span>
                                    <select id="ddlTaxName" class="form-control select2" data-placeholder="Select Tax " tabindex="10"></select>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divRoundoff">
                            <input type="text" class="form-control" id="txtRoundoff" placeholder="Roundoff" style="font-size: 104%; font-weight: bold;"
                                maxlength="15" tabindex="15" value="0" autocomplete="off" />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8" id="divAddress">
                            <label>
                                Comments</label>
                            <textarea id="txtComments" class="form-control" maxlength="1000" tabindex="22" rows="3" aria-autocomplete="none" style="width: 152%"></textarea>
                        </div>
                    </div>
    ...
    <script src="UserDefined_Js/JRetailSalesReturn.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/JRetailSalesReturn.js") %>"
    ...
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmRetailSalesReturn.aspx") %>';
