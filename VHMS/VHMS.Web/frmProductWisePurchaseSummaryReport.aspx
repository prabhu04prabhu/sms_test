<%@ Page Title="Product Wise Purchase Summary Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmProductWisePurchaseSummaryReport.aspx.cs" Inherits="frmProductWisePurchaseSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Product Wise Purchase Summary Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Product Wise Purchase Summary Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divSupplier">
                                    ...
                                    <asp:DropDownList ID="ddlSupplier" CssClass="select2" OnSelectedIndexChanged="ddlSupplier_SelectedIndexChanged" AutoPostBack="true" Width="200" Height="30" runat="server">
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Product Wise Purchase Summary Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
