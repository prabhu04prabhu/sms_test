<%@ Page Title="Dosage" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmDosage.aspx.cs" Inherits="frmDosage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group" id="divName">
                                ...
                                <input type="text" class="form-control" id="txtName" placeholder="Please enter Dosage Name"
    ...
    <script type="text/javascript">
        ...
        $("#btnAddNew").click(function () {
            ...
            $("#btnSave").show();
            $("#btnUpdate").hide();
            $(".modal-title").html("<i class='fa fa-plus-square'></i>&nbsp;&nbsp;Add Dosage");
        ...
        $("#btnSave,#btnUpdate").click(function () {
            ...
            var Obj = new Object();
            Obj.DosageID = 0;
            Obj.DosageName = $("#txtName").val().trim();
            Obj.DosageCode = $("#txtCode").val();
            Obj.IsActive = $("#chkStatus").is(':checked') ? "1" : "0";

            var sMethodName;
            if ($("#hdnID").val() > 0) {
                Obj.DosageID = $("#hdnID").val();
                sMethodName = "UpdateDosage";
            }
            else { sMethodName = "AddDosage"; }

            SaveandUpdateDosage(Obj, sMethodName);
            return false;
        });
                            ...
                            if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                                ...
                                if (obj.length > 0) {
                                    ...
                                    for (var index = 0; index < obj.length; index++) {
                                        ...
                                        var table = "<tr id='" + obj[index].DosageID + "'>";
                                        table += "<td>" + (index + 1) + "</td>";
                                        table += "<td>" + obj[index].DosageName + "</td>";
                                        table += "<td class='hidden-xs'>" + obj[index].DosageCode + "</td>";
                                        table += "<td class='hidden-xs'>" + TypeStatus + "</td>";

                                        if (ActionView == "1")
                                        { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].DosageID + " class='View' title='Click here to View'><i class='fa fa-lg fa-clone text-yellow'/></a></td>"; }
                                        else { table += "<td></td>"; }

                                        if (ActionUpdate == "1")
                                        { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].DosageID + " class='Edit' title='Click here to Edit'><i class='fa fa-lg fa-edit'/></a></td>"; }
                                        else
                                        { table += "<td></td>"; }

                                        if (ActionDelete == "1")
                                        { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].DosageID + " class='Delete' title='Click here to Delete'><i class='fa fa-lg fa-trash-o text-red'/></a></td>"; }
                                        else
                                        { table += "<td></td>"; }
                                    ...
                                    $(".View").click(function () {
                                        if (ActionView == "1") {
                                            ...
                                            $(".modal-title").html("<i class='fa fa-clone'></i>&nbsp;&nbsp;View Dosage");
                                            $("#btnSave").hide();
                                            $("#btnUpdate").hide();
                                        }
                                        else {
        ...
        function SaveandUpdateDosage(Obj, sMethodName) {
            $.ajax({
                type: "POST",
                ...
                success: function (data) {
                    if (data.d != "") {
                        ...
                        if (objResponse.Status == "Success") {
                            ...
                            else if (objResponse.Value == "Dosage_A_01" || objResponse.Value == "Dosage_U_01") {
        ...
        function EditRecord(id) {
            ...
            $.ajax({
                type: "POST",
                url: "WebServices/VHMSService.svc/GetDosageByID",
                        ...
                        if (objResponse.Status == "Success") {
                            if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                                ...
                                if (obj != null) {
                                    ...
                                    $("#hdnID").val(obj.DosageID);
                                    $("#txtName").val(obj.DosageName);
                                    $("#txtCode").val(obj.DosageCode);

                                    $("#chkStatus").prop("checked", obj.IsActive ? true : false);

                                    $('#compose-modal').modal({ show: true, backdrop: true });
                                    $(".modal-title").html("<i class='fa fa-pencil'></i>&nbsp;&nbsp;Edit Dosage");
                                }
                                dProgress(false);
                            }
                            else if (objResponse.Value == "NoRecord") {
        ...
        function DeleteRecord(id) {
            $.ajax({
                type: "POST",
                url: "WebServices/VHMSService.svc/DeleteDosage",
                data: JSON.stringify({ ID: id }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data.d != "") {
                        ...
                        if (objResponse.Status == "Success") {
                            ...
                            else if (objResponse.Value == "Dosage_R_01" || objResponse.Value == "Dosage_D_01") {
