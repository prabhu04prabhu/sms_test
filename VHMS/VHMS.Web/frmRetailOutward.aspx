<%@ Page Title="RetailOutward" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmRetailOutward.aspx.cs" Inherits="frmRetailOutward" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
                        ...
                        <div class="box box-warning">
                            <div class="box-body">
                                <div class="form-group" id="divSearchaname">
                                    <label>
                                       Retail Outwards</label><span class="text-danger">*</span>
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">Retail Outwards</div>
                </div>
                <div class="box-body">
                    <div class="row">
    ...
    <input type="hidden" id="hdnRetailOutwardID" />
    <input type="hidden" id="hdnRetailOutwardsID" />
    <input type="hidden" id="hdnLastinvoiceDate" />
    <input type="hidden" id="hdnRetailOutwardTransID" />
    ...
    <input type="hidden" id="hdnRetailOutwardsLimit" />
    <input type="hidden" id="hdnCustomerBalanceAmount" />
    <input type="hidden" id="hdnRetailOutwardsDiscountPercent" />
    <input type="hidden" id="hdnMaxRetailOutwardsDiscount" />
    ...
    <script src="UserDefined_Js/jRetailOutward.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jRetailOutward.js") %>" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmRetailOutward.aspx") %>';
        ...
        document.onkeydown = function () {
            if (event.keyCode == 67 && event.altKey) {
                ...
                if ($("#ddlProductName").val() > 0) {
                    if ($("#txtCode").val() != "")
                        GetRetailOutwardsProductDetails($("#ddlProductName").val(), $("#txtCode").val(), 0, $("#ddlCustomerName").val());
                    else
                        GetRetailOutwardsProductDetails($("#ddlProductName").val(), $("#hdnSMSCode").val(), 0, $("#ddlCustomerName").val());
                    //$(".modal-title").html("&nbsp;&nbsp; Last 10 RetailOutwards details of this Product to this Customer");
