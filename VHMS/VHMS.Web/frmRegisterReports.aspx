<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/VHMSMasterPage.master" CodeFile="frmRegisterReports.aspx.cs" Inherits="frmRegisterReports" %>
    ...
    <div class="container-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Register Report</li>
            </ol>
                    ...
                    <div class="row table-responsive" id="divRecords"><asp:Label ID="lblTotal" CssClass="lblTotal" runat="server" />
                        <asp:GridView ID="gvRegister"  runat="server" Caption="Register Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Cus. Mobile" ReadOnly="true" DataField="MobileNo" />
                               ...
                               <%-- <asp:BoundField HeaderText="Installment Amount" ReadOnly="true" DataField="InstallmentAmount" />--%>
                                ...
                                <asp:TemplateField HeaderText="Installment Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAmount" runat="server" oncli Style="width: 10px;" Text='<%# ""+Eval("InstallmentAmount").ToString()%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
