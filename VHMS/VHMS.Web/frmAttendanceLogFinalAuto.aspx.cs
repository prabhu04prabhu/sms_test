...
public partial class frmAttendanceLogFinalAuto : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            // txtFromDate.Text = DateTime.Now.ToString("22/11/2021");
            LoadReport();
            LoadDisplay();
        }
    }
                ...
                //{
                    ...
                    if (dsAttendanceLog.Tb_EmployeeAttendence.Rows.Count > 0)
                    {
                        ...
                        objRegion.Active = true;
                            ...
                            //    dsAttendanceLogFinal.Tb_AttendanceLog.Rows.Add(drGSTAnnexureII);
                        }
                    }
                    dsAttendanceLog = new ReportDatestNew();
                    ...
                    if (dsAttendanceLog.Tb_EmployeeAttendence.Rows.Count > 0)
                    {
                        foreach (ReportDatestNew.Tb_EmployeeAttendenceRow drRows in dsAttendanceLog.Tb_EmployeeAttendence.Rows)
                        {
                            ...
                            {
                                objRegion.PunchOutTime = drtEmployeeRow.EmployeeOutTime;
