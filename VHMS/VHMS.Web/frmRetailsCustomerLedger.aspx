<%@ Page Title="Retails Customer Ledger Report" Language="C#" AutoEventWireup="true"
    MasterPageFile="~/VHMSReportPage.master" CodeFile="frmRetailsCustomerLedger.aspx.cs"
    Inherits="frmRetailsCustomerLedger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Retails Customer Ledger Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Retails Customer Ledger Report</li>
            </ol>
            ...
            <section class="content">
                <div class="box box-warning box-solid" id="divFilter">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-1">
                                <asp:Button ID="PrintSummary" Text="print" CausesValidation="false" CssClass="btn btn-info" Style="margin-top: 25PX; margin-left: -129px; height: 30px; width: 60px; padding-top: 4PX;" OnClick="btnPrint_Click" runat="server" />
                            </div>
                            <div class="form-group col-md-1">
                                <asp:Button ID="btnExcel" Text="Excel" CausesValidation="false" CssClass="btn btn-info" Style="margin-top: 25PX; margin-left: -129px; height: 30px; width: 60px; padding-top: 4PX;" OnClick="btnExcel_Click" runat="server" />
                            </div>
                            <div class="form-group col-md-1" style="margin-left: -150px;">
                ...
                <div class="content">
                    ...
                    <CR:CrystalReportViewer ID="CRDischargeSummaryReport" CssClass="report" ToolPanelView="None" runat="server"
                        Width="100%" HasCrystalLogo="False" HasToggleGroupTreeButton="False" HasDrillUpButton="False" HasDrilldownTabs="False" HasRefreshButton="False" />
                </div>
