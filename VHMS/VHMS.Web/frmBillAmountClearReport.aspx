<%@ Page Title="Bill Amount Clearance" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmBillAmountClearReport.aspx.cs" Inherits="frmBillAmountClearReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Bill Amount Clearance
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Bill Amount Clearance</li>
            </ol>
                    ...
                    <div class="box box-warning box-solid" id="divFilter">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-1">
                                    <asp:Button ID="btnPDF" Text="Update" CausesValidation="false" CssClass="btn btn-info" Style="margin-top: 25PX; height: 30px; width: 60px; padding-top: 4PX;" OnClick="btnPDF_Click" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Bill Amount Clearance" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_RetailPaymentModeID"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Select" >
                                    <ItemTemplate>
                                        <asp:CheckBox ID="SelectChkBox" runat="server" AutoPostBack="false" CssClass="BigCheckBox" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="ID" ReadOnly="true" DataField="PK_RetailPaymentModeID" />
                            </Columns>
