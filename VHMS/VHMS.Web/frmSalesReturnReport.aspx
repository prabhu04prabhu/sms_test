<%@ Page Title="Whole Sales Return Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" CodeFile="frmSalesReturnReport.aspx.cs" Inherits="frmSalesReturnReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Whole Sales Return Report 
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Whole Sales Return Report</li>
            </ol>
            ...
            <section class="content">
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                               ...
                               <div class="form-group col-md-2" id="Branch">
                                 ...
                                 <div class="form-group col-md-2" id="divDateType">
                                    ...
                                    <asp:DropDownList ID="ddlDatetype" AutoPostBack="false" Width="200" Height="30" runat="server"  CssClass="select2">
                                       <asp:ListItem Text="Return Date" Value="Entry Date"></asp:ListItem>
                                       <asp:ListItem Text="Debit note Date" Value="Invoice Date"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="row" id="divRecords">  <%--<asp:Label ID="lblTotal" runat="server" />--%>
                        <asp:GridView ID="gvSalesReturn" runat="server"  Caption="SalesReturn Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="ReturnDate" ReadOnly="true" DataField="ReturnDate" DataFormatString="{0:dd/MM/yyyy}" />
                                 <asp:BoundField HeaderText="Debit No" ReadOnly="true" DataField="BillNo" />
                                <asp:BoundField HeaderText="Debit Date" ReadOnly="true" DataField="BillDate" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:BoundField HeaderText="TotalAmount" ReadOnly="true" DataField="TotalAmount" />
                                 <asp:BoundField HeaderText="DiscountAmount" ReadOnly="true" DataField="DiscountAmount" />
