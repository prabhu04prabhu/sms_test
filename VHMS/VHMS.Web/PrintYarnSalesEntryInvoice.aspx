<%@ Page Title="Print Yarn Sales Invoice" Language="C#" MasterPageFile="~/VHMSReportPage.master"
    AutoEventWireup="true" CodeFile="PrintYarnSalesEntryInvoice.aspx.cs" Inherits="PrintYarnSalesEntryInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper hidden">
        <div class="content-header">
            <h1>Print Yarn Sales Invoice
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Transaction</a></li>
                <li><a href="#">Sales</a></li>
                <li class="active">Print Yarn Sales Invoice</li>
            </ol>
        </div>
