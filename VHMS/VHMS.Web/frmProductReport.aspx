        ...
        <section class="content-header">
            ...
            <section class="content">
                ...
                <div class="row table-responsive" id="divRecords">
                    ...
                    <asp:GridView ID="gvReceipt" runat="server" Caption="" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                        AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_ProductID"
                        EmptyDataText="No Records Found" OnRowDataBound="GridView2_RowDataBound" OnDataBound="OnDataBound" ShowFooter="false" AllowSorting="false">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Product Type" ReadOnly="true" DataField="ProductTypeName" />
                            <asp:BoundField HeaderText="Supplier" ReadOnly="true" DataField="SupplierName" />
                            <asp:BoundField HeaderText="SupplierProductName" ReadOnly="true" DataField="SupplierProductName" />
                            ...
                            <asp:BoundField HeaderText="Design No" ReadOnly="true" DataField="DesignNo" />
                            <asp:BoundField HeaderText="Section" ReadOnly="true" DataField="SectionName" />
