<%@ Page Title="Retail Sales Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmRetailSalesDetailedReport.aspx.cs" Inherits="frmRetailSalesDetailedReport" %>
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Retails Sales Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="FK_SalesEntryID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="PaymentMode" ReadOnly="true" DataField="PaymentMode" />
