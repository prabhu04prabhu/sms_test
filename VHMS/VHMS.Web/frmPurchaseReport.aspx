<%@ Page Title="Purchase Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPurchaseReport.aspx.cs" Inherits="frmPurchaseReport" %>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <label>
                                        Report Type</label>
                                    <asp:DropDownList ID="dllReportType" runat="server" TabIndex="7" CssClass="select2">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Purchase Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PurchaseReportID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Total Quantity " ReadOnly="true" DataField="Quantity" />
                                ...
                                <asp:TemplateField HeaderText="InvoiceAmount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotal" runat="server" Style="width: 10px;" Text='<%# ""+Eval("InvoiceAmount").ToString()%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
