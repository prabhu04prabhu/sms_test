<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/VHMSMasterPage.master" CodeFile="frmUnPaidReports.aspx.cs" Inherits="frmUnPaidReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
                    ...
                    <div class="box box-warning box-solid" style="width: 100%;" id="divFilter">
                       ...
                       <%--           <div class="form-group col-md-2 col-sm-4" style="margin-left: -5px;" id="divDOB">
                                ...
                                <div class="form-group col-md-2" style="margin-left: -5px;" id="Scheme">
                                    ...
                                    <asp:DropDownList ID="ddlScheme" AutoPostBack="False"  Style="width: 200px; Height:30px;" runat="server">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div class="form-group col-md-1 btn-group">
                                    <asp:Button ID="btnView" Text="View" CausesValidation="false" Style="margin-top: 22px;" CssClass="btn btn-info" OnClick="btnView_Click" runat="server" />
                                </div>
                                 <div class="form-group col-md-1 btn-group">
                                    <asp:Button ID="btnprint" Text="print" CausesValidation="false" Style="margin-top: 22px;" CssClass="btn btn-info" OnClientClick="doPrint();return false;" runat="server" />
                                </div>
                                 <div class="form-group col-md-1 btn-group">
                                    <asp:Button ID="btnExcel" Text="Excel" CausesValidation="false" Style="margin-top: 22px;"  CssClass="btn btn-info" OnClick="btnExcel_Click" runat="server" />
                                </div>
                                 <div class="form-group col-md-1 btn-group">
                                    <asp:Button ID="btnPDF" Text="PDF" CausesValidation="false" Style="margin-top: 22px;" CssClass="btn btn-info" OnClick="btnPDF_Click" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <asp:GridView ID="gvUnPaid"  runat="server" Caption="Unpaid Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Installment Amount" ReadOnly="true" DataField="InstallmentAmount" />
                                 <asp:BoundField HeaderText="Pending Dues" ReadOnly="true" DataField="NoOfDues" />
                                <%--<asp:BoundField HeaderText="Balance Amount" ReadOnly="true" DataField="Balance" />--%>
    ...
    <script>
        function doPrint() {
            var prtContent = document.getElementById('<%=   gvUnPaid.ClientID   %>');
