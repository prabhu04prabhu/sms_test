<%@ Page Title="INLREntry Reports" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmINLREntryReports.aspx.cs" Inherits="frmINLREntryReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>INLREntry Reports
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">INLREntry Reports</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    <div class="box box-warning box-solid" id="divFilter">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divCategory" style="display: none;">
                                ...
                                <div class="form-group col-md-2" id="divProduct" style="display: none;">
                                    <label>Product</label><span class="text-danger">*</span>
                                    <asp:DropDownList ID="ddlProduct" Width="350" Height="30" runat="server" CssClass="select2">
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="INLREntry Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_INLREntryID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="LREntryNo" ReadOnly="true" DataField="LREntryNo" />
                                <asp:BoundField HeaderText="LREntryDate" ReadOnly="true" DataField="LREntryDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="PurchaseNo" ReadOnly="true" DataField="PurchaseNo" />
                                <asp:BoundField HeaderText="PurchaseDate" ReadOnly="true" DataField="PurchaseDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="SupplierName" ReadOnly="true" DataField="SupplierName" />
                                <asp:BoundField HeaderText="Delivery_Date" ReadOnly="true" DataField="Delivery_Date" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="TransportName" ReadOnly="true" DataField="TransportName" />
                                <asp:BoundField HeaderText="LRNo" ReadOnly="true" DataField="AWBNo" />
                                <asp:BoundField HeaderText="Payment Mode" ReadOnly="true" DataField="Payment" />
                                <asp:BoundField HeaderText="Bundles" ReadOnly="true" DataField="No_of_Bundles" />
                                <asp:BoundField HeaderText="Followed_Person" ReadOnly="true" DataField="Followed_Person" />
