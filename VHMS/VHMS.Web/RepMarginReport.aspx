<%@ Page Title="Margin Report" Language="C#" MasterPageFile="~/VHMSReportPage.master"
    AutoEventWireup="true" CodeFile="RepMarginReport.aspx.cs" Inherits="RepMarginReport" %>
    ...
    <div class="container-wrapper hidden">
        <div class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Margin Report</li>
            </ol>
        </div>
        <div class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <asp:DropDownList ID="ddluser" runat="server" data-placeholder="Select User" TabIndex="3"
                                        CssClass="select2">
                                        <asp:ListItem Value="Abstract MonthWise" Text="Abstract MonthWise"></asp:ListItem>
                                        <asp:ListItem Value="BillWise" Selected="True" Text="Bill Wise"></asp:ListItem>
                                        <asp:ListItem Value="BillWiseDetailed" Text="Bill Wise Detailed"></asp:ListItem>
                                        <asp:ListItem Value="Abstract" Text="Abstract"></asp:ListItem>
                                        <asp:ListItem Value="Abstract YearWise" Text="Abstract YearWise"></asp:ListItem>
                                        <%--<asp:ListItem Value="ProductWise" Text="Product Wise"></asp:ListItem>--%>
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-md-2">
                                    <label>
