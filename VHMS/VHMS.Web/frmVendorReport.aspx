<%@ Page Title="Vendor Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmVendorReport.aspx.cs" Inherits="frmVendorReport" %>
    ...
    <div class="container-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Vendor Report</li>
            </ol>
                ...
                <div class="table-responsive">
                    <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                            ...
                            <div class="box-body">
                                <div class="row">
                                   <%-- <div class="form-group col-md-2" id="divVendor">
                                        <label>
                                            Vendor Type</label><span class="text-danger">*</span>
                                        <asp:DropDownList ID="ddlVendor" OnSelectedIndexChanged="ddlProduct1_SelectedIndexChanged"
                        ...
                        <div class="row" id="divRecords">
                            <asp:GridView ID="gvProductMas" runat="server" Caption="Vendor Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                                AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_VendorID"
                                EmptyDataText="No Records Found" AllowSorting="true">
                                <Columns>
                                    <asp:TemplateField HeaderText="S.No">
                                        <ItemTemplate><%#Container.DataItemIndex+1 %></ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="VendorName" ReadOnly="true" DataField="VendorName" />
                                    <asp:BoundField HeaderText="Code" ReadOnly="true" DataField="VendorCode" />
                                    <asp:BoundField HeaderText="Address" ReadOnly="true" DataField="VendorAddress" />
                                    <asp:BoundField HeaderText="PhoneNo1" ReadOnly="true" DataField="PhoneNo1" />
                                    <asp:BoundField HeaderText="PhoneNo2" ReadOnly="true" DataField="PhoneNo2" />
                                </Columns>
