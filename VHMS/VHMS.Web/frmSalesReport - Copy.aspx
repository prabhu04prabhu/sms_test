<%@ Page Title="Whole Sales Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" 
    AutoEventWireup="true" CodeFile="frmSalesReport - Copy.aspx.cs" Inherits="frmSalesReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Whole Sales Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Whole Sales Report</li>
            </ol>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divPaymentMode"  style="display:none;">
                                    ...
                                    <asp:DropDownList ID="ddlArea" AutoPostBack="false" Width="200" Height="30" runat="server" CssClass="select2">
                                       
                                    </asp:DropDownList>
                                </div>
                                 <div class="form-group col-md-2" id="divType">
                                    <label>
                                        Report Type</label><span class="text-danger">*</span>
                                    <asp:DropDownList ID="ddlType" AutoPostBack="false" Width="200" Height="30" runat="server"  CssClass="select2">
                                       <asp:ListItem Text="All" Value="All"></asp:ListItem>
                                          <asp:ListItem Text="Whole Sales" Value="WholeSales"></asp:ListItem>
                                        <asp:ListItem Text="Yarn Sales" Value="YarnSales"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-md-2" id="divDateType">
                                    <label>
                                        Date Type</label><span class="text-danger">*</span>
                                    <asp:DropDownList ID="ddlDatetype" AutoPostBack="false" Width="200" Height="30" runat="server"  CssClass="select2">
                                       <asp:ListItem Text="Invoice Date" Value="Invoice Date"></asp:ListItem>
                                       <asp:ListItem Text="Entry Date" Value="Entry Date"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
