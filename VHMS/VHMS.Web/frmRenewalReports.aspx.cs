...
public partial class frmRenewalReports : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintRenewal(txtDOB.Text, txtDOR.Text, txtMobile.Text, ddlScheme.SelectedValue, ddlBranch.SelectedValue, ddlEmployeeCode.SelectedValue, RegionID, ZoneID);
        try
        {
