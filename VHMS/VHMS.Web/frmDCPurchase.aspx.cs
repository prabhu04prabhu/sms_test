...
public partial class frmDCPurchase : BaseConfig
{
    protected string UploadFolderPath = "~/images/Documents/DCPurchase/";
    ...
    public static string saveimage(string data)
    {
        ...
        return "images/Documents/DCPurchase/Images/" + imageName;
    }
}