<%@ Page Title="Bank Statement" Language="C#" AutoEventWireup="true" MasterPageFile="~/VHMSMasterPage.master" CodeFile="frmBankStatement.aspx.cs" Inherits="frmBankStatement" %>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2" id="divDOR">
                             ...
                             <div class="form-group col-md-2" id="Branch">
                                    <label>
                                        Account</label><span class="text-danger">*</span>
