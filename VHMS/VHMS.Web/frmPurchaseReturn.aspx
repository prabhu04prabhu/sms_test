        ...
        <section class="content">
            ...
            <div class="box box-primary" id="divOPBilling">
                ...
                <div class="box-body">
                    <div class="row">
                       ...
                       <%-- <span style="padding-left: 30px" />--%>
                        ...
                        <div class="form-group col-md-2" id="divAllProductType">
                            <input type="radio" name="SupplierProduct" id="rdoAll" value="A" tabindex="-1" />All Products
                        </div>
                        <div class="form-group col-md-1" style="display:none;"> 
                            <label>
                                <input type="checkbox" id="chkIsDiscount" tabindex="6" />&nbsp;&nbsp;&nbsp; IsDiscount
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12" id="divAddress">
                            <label>
                                Comments</label>
                            <textarea id="txtComments" class="form-control" maxlength="255" tabindex="19" rows="3" aria-autocomplete="none"></textarea>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-footer clearfix">
                    <button id="btnSave" type="button" class="btn btn-info pull-left" tabindex="20">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Save & Print</button>
                    <button id="btnUpdate" type="button" class="btn btn-info pull-left" tabindex="21">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Update Changes</button>
                    <button id="btnPrintbill" type="button" class="btn btn-info btnPrint margin pull-left" tabindex="22">
            ...
            <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix">
                            <button type="submit" class="btn btn-info pull-left" id="btnOK" tabindex="26">
                                <i class="fa fa-save"></i>&nbsp;&nbsp;
                                Save</button>
                            <button type="button" class="btn btn-danger pull-right" id="btnCancel" tabindex="27">
            ...
            <div class="modal fade" id="composeImage" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-danger pull-left" id="btnImageCancel" tabindex="28">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="composeProductImage" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-danger pull-left" id="btnProductImageCancel" tabindex="29">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
