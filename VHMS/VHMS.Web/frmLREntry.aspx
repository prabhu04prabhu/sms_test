<%@ Page Title="LREntry" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmLREntry.aspx.cs" Inherits="frmLREntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
                        ...
                        <div class="box box-warning">
                            <div class="box-body">
                                <div class="form-group" id="divSearchaname">
                                    <label>
                                        Search LREntry records</label><span class="text-danger">*</span>
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">LREntry Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divEWayNo">
                            <label>
                                EWay No</label><span class="text-danger">*</span> <button id="btnLink" type="button" class="btn btn-link">
                        ...
                        <div class="form-group col-md-2" id="divLRDate">
                            <label>
                               LR Date</label><span class="text-danger">*</span>
                            <div class="input-group date form_date" data-date-format="dd/MM/yyyy HH:ii P" data-link-field="txtLRDate"
                                data-link-format="dd/MM/yyyy">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar glyphicon glyphicon-calendar"></i>
                                </div>
                                <input type="text" class="form-control pull-right" tabindex="2" id="txtLRDate" readonly />
                            </div>
                        </div>
                        </div>
                       <div class="row">
    ...
    <input type="hidden" id="hdnLREntryID" />
    <input type="hidden" id="hdnLREntryTransID" />
    ...
    <script src="UserDefined_Js/jLREntry.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jLREntry.js") %>" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var _CMDSalesEntryID = '<%=Session["SalesEntryID"]%>';
        var pageUrl = '<%=ResolveUrl("~/frmLREntry.aspx") %>';
