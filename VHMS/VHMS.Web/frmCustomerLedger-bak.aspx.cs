...
public partial class frmCustomerLedger_bak: System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=BuyerLedger.xls");
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                (CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Response, true, "CustomerLedger summary");
            }
            catch (Exception ex)
            {
        ...
        try
        {
            ...
            if (ddluser.Text == "Detailed")
            {
                if (dsReportData.tCustomer.Rows.Count > 0)
                {
                    ...
                    foreach (ReportDataSet.tCustomerRow drtJobCardRow in dsReportData.tCustomer)
                    {
                        ...
                        TableHTML += "<table cellpadding='0' cellspacing='0' ><thead><tr><th  style='text-align:center;'Colspan='5'>Buyer Ledger</th></tr></thead></table>";
                        TableHTML += "<table cellpadding='0' cellspacing='0'><thead>";
                        TableHTML += "<tr><td colspan='3'><b>Mr./Ms." + drtJobCardRow.CustomerName + "</b></td><td colspan='2'><b>Phone No.: " + drtJobCardRow.MobileNo + "</td></tr>";
                        TableHTML += "<tr><td colspan='5'> " + drtJobCardRow.Address + "</td></tr>";
                        TableHTML += "<br/>";
                        TableHTML += "</thead></table>";
                        TableHTML += "<table cellpadding='0' cellspacing='0' class='border_details' ><thead>";
                        TableHTML += "<tr><th style='width:10%;'><b> Date</b></th><th style='width:40%;'><b>Particulars</b></th></th><th style='width:15%;text-align:right'><b>Debit</b></th><th style='width:15%;text-align:right'><b>Credit</b></th><th style='width:15%;text-align:right'><b>Balance</b></th></tr></thead>";
                        ...
                        if (dsReportData.tStatement.Rows.Count > 0)
                        {
                            ...
                            foreach (ReportDataSet.tStatementRow drtJobCardComplaintsRow in dsReportData.tStatement)
                            {
                                ...
                                TableHTML += "<tr><td style='width:10%;'>" + VDate + "</td><td>" + drtJobCardComplaintsRow.Particulars + "</td><td  style='text-align:right'> " + drtJobCardComplaintsRow.Debit + "</td><td  style='text-align:right'>" + drtJobCardComplaintsRow.Credit + "</td><td  style='text-align:right'>" + BalanceType + "</td></tr>";
                                sno++;
                            }
                        }
