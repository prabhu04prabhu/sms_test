...
public partial class frmPurchaseDiscount : BaseConfig
{
    ...
    public static string saveimage(string data)
    {
        ...
        String path = HttpContext.Current.Server.MapPath("~/images/Documents/PurchaseDiscount");
        string imgPath = Path.Combine(path, imageName);
        File.WriteAllBytes(imgPath, imgarr);
        return "images/Documents/PurchaseDiscount/" + imageName;
    }
}