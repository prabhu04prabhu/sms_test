<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/VHMSMasterPage.master" CodeFile="frmReceiptReportsOLD.aspx.cs" Inherits="frmReceiptReportsOLD" %>
    ...
    <div class="container-wrapper">
        <section class="content-header">
            ...
            <section class="content">
                    ...
                    <div class="row table-responsive" id="divRecords"><asp:Label ID="lblTotal" CssClass="lblTotal" runat="server" />
                        <asp:GridView ID="gvReceipt"  runat="server" Caption="Receipt Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="S.No">
                                    ...
                                    <asp:BoundField HeaderText="RenewalDate" ReadOnly="true" DataField="RenewalDate"  DataFormatString="{0:dd/MM/yyyy}" />
                              ...
                              <%--  <asp:BoundField HeaderText="Duration" ReadOnly="true" DataField="Duration" />--%>
                                <%--<asp:BoundField HeaderText="Paid Amount" ReadOnly="true" DataField="AmountPaid" />--%>
