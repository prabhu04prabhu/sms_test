<%@ Page Title="Supplier Ledger Summary Report" Language="C#" MasterPageFile="~/VHMSReportPage.master"
    AutoEventWireup="true" CodeFile="frmSupplierLedgerSummary.aspx.cs" Inherits="frmSupplierLedgerSummary" %>
    ...
    <div class="container-wrapper hidden">
        <div class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Supplier Ledger Summary Report</li>
            </ol>
        </div>
        <div class="content">
    ...
    <script type="text/javascript">
        document.onkeydown = function () {
            if (event.keyCode == 113) {
                var myWindow = window.open("frmDSupplierLedgerSummary.aspx", "_self");
            }
        };
