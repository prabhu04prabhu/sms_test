<%@ Page Title="Purchase Combined Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPurchaseCombinedReport .aspx.cs" Inherits="frmPurchaseCombinedReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Purchase Combined Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Purchase Combined Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Purchase Combined Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Taxable Amount" ReadOnly="true" DataField="TotalAmount" />
                                <asp:BoundField HeaderText="Invoice Amount" ReadOnly="true" DataField="NetAmount" />
                                <asp:BoundField HeaderText="Return Qty" ReadOnly="true" DataField="ReturnQty" />
                                <asp:BoundField HeaderText="Return Amount" ReadOnly="true" DataField="ReturnAmount" />
                                <asp:BoundField HeaderText="Purchase Dicount" ReadOnly="true" DataField="PurchaseDicount" />
                            </Columns>
