...
public partial class frmSalesDiscount : BaseConfig
{
    ...
    public static string saveimage(string data)
    {
        ...
        String path = HttpContext.Current.Server.MapPath("~/images/Documents/SalesDiscount");
        string imgPath = Path.Combine(path, imageName);
        File.WriteAllBytes(imgPath, imgarr);
        return "images/Documents/SalesDiscount/" + imageName;
    }
}