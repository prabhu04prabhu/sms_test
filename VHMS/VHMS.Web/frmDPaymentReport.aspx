<%@ Page Title="D Payment Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" 
    CodeFile="frmDPaymentReport.aspx.cs" Inherits="frmDPaymentReport" %>
    ...
    <div class="container-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">DPayment Report</li>
            </ol>
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Payment Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="VoucherNo" ReadOnly="true" DataField="VoucherNo" />
                                 <asp:BoundField HeaderText="Entry Date" ReadOnly="true" DataField="VoucherDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Collection Date" ReadOnly="true" DataField="CollectionDate" DataFormatString="{0:dd/MM/yyyy}" />
...
<%--                                <asp:BoundField HeaderText="BillDates" ReadOnly="true" DataField="BillDates" DataFormatString="{0:dd/MM/yyyy}" />--%>
                                ...
                                <asp:BoundField HeaderText="Discount Amount" ReadOnly="true" DataField="Discount_Amount" />
