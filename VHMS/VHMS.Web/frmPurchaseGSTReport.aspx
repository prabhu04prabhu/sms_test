<%@ Page Title="Purchase GST" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPurchaseGSTReport.aspx.cs" Inherits="frmPurchaseGSTReport" %>
    ...
    <div class="container-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Purchase GST</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Purchase GST Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Supplier Name" ReadOnly="true" DataField="PartyName" />
                                <asp:BoundField HeaderText="GSTIN" ReadOnly="true" DataField="GSTIN" />
                                <asp:BoundField HeaderText="BillEntry Date" ReadOnly="true" DataField="EntryDate" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:BoundField HeaderText="Invoice Value" ReadOnly="true" DataField="InvoiceValue" />
