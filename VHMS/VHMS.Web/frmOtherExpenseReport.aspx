<%@ Page Title="Other Expense Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" CodeFile="frmOtherExpenseReport.aspx.cs" Inherits="frmOtherExpenseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Other Expense Report 
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Other Expense Report</li>
            </ol>
            ...
            <section class="content">
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">  <%--<asp:Label ID="lblTotal" runat="server" />--%>
                        <asp:GridView ID="gvSalesReturn" runat="server"  Caption="Other Expense Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_JournalTransID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Expense No" ReadOnly="true" DataField="JournalNo" />
                                <asp:BoundField HeaderText="Entry Date" ReadOnly="true" DataField="JournalDate" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:BoundField HeaderText="Bill Date" ReadOnly="true" DataField="BillDate" DataFormatString="{0:dd/MM/yyyy}" />
                                 <asp:BoundField HeaderText="Ledger" ReadOnly="true" DataField="LedgerName" />                                
                                <asp:BoundField HeaderText="Payment Mode" ReadOnly="true" DataField="Payment_mode" />
                                <asp:BoundField HeaderText="Narration " ReadOnly="true" DataField="Narration" />
                                <asp:BoundField HeaderText="Amount" ReadOnly="true" DataField="CreditAmount" />
                            </Columns>
