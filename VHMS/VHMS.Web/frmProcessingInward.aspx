<%@ Page Title="Processing Outward" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmProcessingInward.aspx.cs" Inherits="frmProcessingInward" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
                        ...
                        <div class="box box-warning">
                            <div class="box-body">
                                <div class="form-group" id="divSearchaname">
                                    <label>
                                        Search Processing Outward records</label><span class="text-danger">*</span>
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">Processing Outward Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divBillNo">
                            <input type="text" class="form-control" id="txtBillNo" placeholder="Outward No"
    ...
    <input type="hidden" id="hdnProcessingInwardID" />
    <input type="hidden" id="hdnProcessingInwardTransID" />
    ...
    <script src="UserDefined_Js/jProcessingInward.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jProcessingInward.js") %>" type="text/javascript"></script>
