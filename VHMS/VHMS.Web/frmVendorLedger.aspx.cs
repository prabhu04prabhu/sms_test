...
public partial class frmVendorLedger : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=VendorLedger.xls");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintVendorLedgerReport(txtDOB.Text, txtDOR.Text, ddlVendor.SelectedValue);
        try
        {
            ...
            if (dsReportData.tVendor.Rows.Count > 0)
            {
                ...
                foreach (ReportDataSet.tVendorRow drtJobCardRow in dsReportData.tVendor)
                {
                    ...
                    TableHTML += "<table cellpadding='0' cellspacing='0' ><thead><tr><th  style='text-align:center;'Colspan='5'>Vendor Ledger</th></tr></thead></table>";
                    TableHTML += "<table cellpadding='0' cellspacing='0'><thead>";
                    TableHTML += "<tr><td Colspan='3'><b>Mr./Ms." + drtJobCardRow.VendorName + "</b></td><td Colspan='2'><b>Phone No.: " + drtJobCardRow.PhoneNo1 + "</td></tr>";
                    TableHTML += "<tr><td Colspan='5'> " + drtJobCardRow.VendorAddress + "</td><td></td></tr>";
                    TableHTML += "<br/>";
                    TableHTML += "</thead></table>";
                    TableHTML += "<table cellpadding='0' cellspacing='0' class='border_details' ><thead>";
                    TableHTML += "<tr><th style='width:20%;'><b> Date</b></th><th style='width:35%;'><b>Particulars</b></th></th><th style='width:15%;text-align:right'><b>Debit(Rs.)</b></th><th style='width:15%;text-align:right'><b>Credit(Rs.)</b></th><th style='width:15%;text-align:right'><b>Balance(Rs.)</b></th></tr></thead>";
    ...
    {
        Response.ContentType = "application/pdf";
        Response.AddHeader("content-disposition", "attachment;filename=VendorLedger.pdf");
        Response.Cache.SetCacheability(HttpCacheability.NoCache);
        StringWriter stringWriter = new StringWriter();
        HtmlTextWriter htmlTextWriter = new HtmlTextWriter(stringWriter);
        divPdf.RenderControl(htmlTextWriter);
