                                ...
                                <div class="row">
                                    <div class="form-group col-md-2" id="divCustomer">
                                        ...
                                        <asp:DropDownList ID="ddlCustomer" OnSelectedIndexChanged="ddlProduct1_SelectedIndexChanged"
                                            ...
                                            <asp:ListItem Text="Sales Customer" Value="Sales"></asp:ListItem>
                        ...
                        <div class="row" id="divRecords">
                            <asp:GridView ID="gvProductMas" runat="server" Caption="Customer Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="State Name" ReadOnly="true" DataField="StateName" />
                                    ...
                                    <asp:BoundField HeaderText="Pincode" ReadOnly="true" DataField="Pincode" />
                                    ...
                                    <asp:BoundField HeaderText="MD Name" ReadOnly="true" DataField="MDName" />
                                    <asp:BoundField HeaderText="MD Contact" ReadOnly="true" DataField="MDContact" />
                                    <asp:BoundField HeaderText="Manger Name" ReadOnly="true" DataField="MangerName" />
                                    <asp:BoundField HeaderText="Manager Contact" ReadOnly="true" DataField="MangerContact" />
                                </Columns>
