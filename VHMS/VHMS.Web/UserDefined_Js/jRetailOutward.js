...
$(function () {
    ...
    if ($.cookie("OPBilling") != undefined) {
        ...
        if (_Tfunctionality == "AddNewOPBilling") {
            ...
            GetReceivedRetailOutward(parseInt($.cookie("RetailOutwardID")));
            $("#hdnRetailOutwardID").val(parseInt($.cookie("RetailOutwardID")));
        }
        $.cookie("OPBilling", null);
        $.cookie("RetailOutwardID", null);
    }
            ...
            if (data.d != "") {
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        var obj = jQuery.parseJSON(objResponse.Value);
                        if (obj != null) {
                            $("#hdnMaxRetailOutwardsDiscount").val(obj.MaxRetailOutwardsDiscount);
...
$("#btnAddNew").click(function () {
    ...
    $("#btnAddNew").hide();
    $("#btnList").show();
    $("#hdnRetailOutwardID").val("0");
    $("#hdnRetailOutwardsID").val("0");
    $("#btnAddMagazine").show();
    $("#btnUpdateMagazine").hide();
...
function GetProductDetails(id, smscode, value, SID, RetailOutwardsID) {
    dProgress(true);
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetNewProductDetails",
        data: JSON.stringify({ ID: id, code: smscode, type: value, SupplierID: SID, RetailOutwardID: RetailOutwardsID }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
                        ...
                        if (obj != null) {
                            ...
                            if (obj.length > 0) {
                                ...
                                for (var i = 0; i < obj.length; i++) {
                                    sTable = "<tr><td style='line-height:0.5;' id='" + obj[i].PK_RetailOutwardTransID + "'>" + sCount + "</td>";
...
function GetRetailOutwardsProductDetails(id, smscode, value, SID, RetailOutwardsID) {
    dProgress(true);
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetNewProductDetails",
...
function GetAllProductDetails(id, smscode, value, SID, RetailOutwardsID) {
    dProgress(true);
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetNewProductDetails",
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            ...
                            $("#hdnRetailOutwardsLimit").val(obj.Limit_RetailOutwardsAmount);
                            $("#hdnRetailOutwardsDiscountPercent").val(obj.Default_DiscountPercent);
...
$("#ddlCustomerName").change(function () {
    if ($("#ddlCustomerName").val() > 0) {
        ...
        GetRate();
        GetProductTax();
        //  GetWholeRetailOutwardsTotalAmount();
    }
});
...
$("#btnAddMagazine,#btnUpdateMagazine").click(function () {
    ...
    if ($("#hdnMaxRetailOutwardsDiscount").val() > 0) {
        if (parseFloat($("#hdnMaxRetailOutwardsDiscount").val()) < parseFloat($("#txtDisPer").val())) {
    ...
    if ($("#hdnRetailOutwardID").val() == 0) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({ ID: $("#ddlProductName").val(), transaction_id: $("#hdnRetailOutwardID").val(), type: "S" }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            success: function (data) {
    ...
    GetProductDetails(ObjData.Product.ProductID, oProduct.SMSCode, 0, $("#ddlCustomerName").val(), $("#hdnRetailOutwardID").val());
    ...
    if (this.id == "btnAddMagazine") {
        ...
        if ($("#hdnRetailOutwardID").val() > 0) {
            ...
            ObjData.RetailOutwardID = $("#hdnRetailOutwardID").val();
        }
        else {
            ObjData.StatusFlag = "I";
            ObjData.RetailOutwardID = 0;
    ...
    if (gData.length > 0) {
        ...
        for (var i = 0; i < gData.length; i++) {
            if (gData[i].StatusFlag != "D") {
                ...
                //if (gData[i].RetailOutwardID == 0)
                //    GetProductDetails(gData[i].Product.ProductID, 0, $("#ddlCustomerName").val(), 0);
                //else
                //    GetProductDetails(gData[i].Product.ProductID, gData[i].PurchaseID, $("#ddlCustomerName").val(), gData[i].RetailOutwardID);
    ...
    for (var i = 0; i < data.length; i++) {
        if (data[i].sNO == ID) {
            if (data[i].StatusFlag != "D") {
                ...
                //$("#hdnRetailOutwardID").val(data[i].RetailOutwardID);
...
function Update_OPBilling(oData) {
    for (var i = 0; i < gOPBillingList.length; i++) {
        if (gOPBillingList[i].sNO == oData.sNO) {
            gOPBillingList[i].RetailOutwardID = oData.RetailOutwardID;
            var oProduct = new Object();
...
function GetRecord() {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetTopRetailOutward",
                ...
                if (objResponse.Status == "Success") {
                    ...
                    if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                        ...
                        if (obj.length > 0) {
                                ...
                                if (obj[index].IsActive == "1") {
                                    ...
                                    if (obj[index].BalanceAmount > 0) {
                                        if (obj[index].DueDays == obj[index].Customer.MinDueDays)
                                            table += "<tr style='background-color:#d9f7927a;' id='" + obj[index].RetailOutwardID + "'>";
                                        else
                                            table += "<tr id='" + obj[index].RetailOutwardID + "'>";
                                    } else
                                        table += "<tr style='background-color:#f1c6ad;' id='" + obj[index].RetailOutwardID + "'>";

                                    // var table = "<tr id='" + obj[index].RetailOutwardID + "'>";
                                    table += "<td>" + (index + 1) + "</td>";
                                    ...
                                    if (ActionView == "1") { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='View' title='Click here to View'><i class='fa fa-lg fa-clone text-yellow'/></a></td>"; }
                                    else { table += "<td></td>"; }

                                    if (ActionUpdate == "1") { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='Edit' title='Click here to Edit'><i class='fa fa-lg fa-edit'/></a></td>"; }
                                    else { table += "<td></td>"; }

                                    if (ActionDelete == "1") { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='Delete' title='Click here to Cancel'><i class='fa fa-lg fa-times-circle text-red'/></a></td>"; }
                                    else { table += "<td></td>"; }

                                    //table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='PrintRetailOutwards' title='Click here to Print Invoice'></i><i class='fa fa-print text-green'/></a></td>";
                                    ...
                                    //table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='LR' title='Click here for LR Entry'><i class='fa fa-truck text-black'></i></a></td>";
                                    //table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='einvoice' invoice='" + obj[index].InvoiceNo + "_" + obj[index].Customer.CustomerName + "' title='E-Invoice JSON format'><i class='fa fa-file-code-o text-black'></i></a></td>";
                            ...
                            //$(".PrintRetailOutwards").click(function () {
                            //    SetSessionValue("RetailOutwardID", parseInt($(this).parent().parent()[0].id));
                            //    var myWindow = window.open("PrintRetailOutwardInvoice.aspx", "MsgWindow");
                            //});
                            //$(".Address").click(function () {
                            //    SetSessionValue("RetailOutwardsID", $(this).attr('Accountno'));
...
function GetSearchRecord(iDetails) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/SearchRetailOutward",
                        ...
                        if (obj.length > 0) {
                            ...
                            for (var index = 0; index < obj.length; index++) {
                                if (obj[index].IsActive == "1") {
                                    ...
                                    //table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='LR' title='Click here for LR Entry'><i class='fa fa-truck text-black'></i></a></td>";
                                    //table += "<td style='text-align:center;'><a href='#' id=" + obj[index].RetailOutwardID + " class='einvoice' invoice='" + obj[index].InvoiceNo + "' title='E-Invoice JSON format'><i class='fa fa-file-code-o text-black'></i></a></td>";
...
$("#btnPrint").click(function () {
    SetSessionValue("RetailOutwardID", $("#hdnRetailOutwardID").val());
    var myWindow = window.open("PrintRetailOutwardInvoice.aspx", "MsgWindow");
});


function GetLastRetailOutwardByID() {
    dProgress(true);
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetLastRetailOutwardByID",
        data: JSON.stringify({ ID: $("#hdnRetailOutwardsID").val(), IsRetail: 0, IsYarnBill: 0 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
...
$("#btnSave,#btnUpdate").click(function () {
    ...
    if ($("#hdnMaxRetailOutwardsDiscount").val() > 0) {
        if (parseFloat($("#hdnMaxRetailOutwardsDiscount").val()) < parseFloat($("#txtDiscountPercent").val())) {
            $.jGrowl(" Discount Percentage Exceeding Maximum discount", { sticky: false, theme: 'warning', life: jGrowlLife });
            $("#txtDiscountPercent").focus(); return false;
        }
    }

    if ($("#hdnRetailOutwardsLimit").val() > 0) {
        if ($("#hdnRetailOutwardID").val() > 0) {
            if ($("#ddlPaymentMode").val() == "Credit") {
                ...
                // var Limit = parseFloat($("#hdnRetailOutwardsLimit").val());
                if ($("#hdnRetailOutwardsLimit").val() < TotalNetAmount) {
    ...
    ObjOPBilling.RetailOutwardID = 0;
    ...
    ObjOPBilling.RetailOutwardTrans = gOPBillingList;
    ...
    var ObjRetailOutwardsOrder = new Object();
    ObjRetailOutwardsOrder.RetailOutwardsOrderID = 0;
    ObjOPBilling.RetailOutwardsOrder = ObjRetailOutwardsOrder;

    var ObjGift = new Object();
    ObjGift.GiftID = 0;
    ObjOPBilling.Gift = ObjGift;

    ObjOPBilling.RetailOutwardsExchangeTrans = [];
    //var ostate = new Object();
    ...
    ObjOPBilling.RetailOutwardsPoints = 0;
    ...
    if ($("#hdnRetailOutwardsID").val() > 0) {
        ObjOPBilling.RetailOutwardID = $("#hdnRetailOutwardsID").val();
        gOPBillingList.RetailOutwardID = ObjOPBilling.RetailOutwardID;
        ...
        sMethodName = "UpdateRetailOutward";
    }
    else {
        sMethodName = "AddRetailOutward";
        ObjOPBilling.RetailOutwardID = 0;
            ...
            if (data.d != "") {
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value > 0) {
                        ...
                        $("#secHeader").removeClass('hidden');
                        $("#divOPBilling").hide();
                        if (sMethodName == "AddRetailOutward") {
                            $.jGrowl("Added Successfully", { sticky: false, theme: 'success', life: jGrowlLife });
                            $("#hdnRetailOutwardID").val(objResponse.Value);
                            EditRecord($("#hdnRetailOutwardID").val());
                            $("#btnSave").hide();
                            $("#btnUpdate").hide();
                            $("#btnPrintbill").show();
                            $("#btnAddMagazine").hide();
                        ...
                        else if (sMethodName == "UpdateRetailOutward") {
                            $.jGrowl("Updated Successfully", { sticky: false, theme: 'success', life: jGrowlLife });
                            EditRecord(ObjO.RetailOutwardID);
                            $("#btnSave").hide();
                            $("#btnUpdate").hide();
                            $("#btnPrintbill").show();
                            //  SetSessionValue("RetailOutwardID", $("#hdnRetailOutwardID").val());
...
function EditRecord(id) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetRetailOutwardByID",
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            ...
                            $("#hdnRetailOutwardsID").val(obj.RetailOutwardID)
                            $("#hdnRetailOutwardID").val(obj.RetailOutwardID)
                            $("#txtBillNo").val(obj.InvoiceNo);
                            ...
                            gOPBillingList = [];
                            var ObjProduct = obj.RetailOutwardTrans;
                            for (var index = 0; index < ObjProduct.length; index++) {
                                ...
                                objTemp.RetailOutwardTransID = ObjProduct[index].RetailOutwardTransID;
                                objTemp.RetailOutwardID = ObjProduct[index].RetailOutwardID;
...
function DeleteRecord(id, Reason) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/DeleteRetailOutward",
...
function EInvoice_Export(id, invoice) {
    ...
    $.ajax({
        type: "POST",
        //url: "WebServices/VHMSService.svc/GetRetailOutwardJsonFormat",
        url: "WebServices/VHMSService.svc/GetRetailOutwardJsonHSNFormat",
        data: JSON.stringify({ ID: id }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
