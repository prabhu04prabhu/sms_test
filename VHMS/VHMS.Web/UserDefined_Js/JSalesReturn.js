...
function GetSalesReturnDetails(id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ InvoiceNo: id, IsRetail: 0}),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
...
function GetRecord() {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ PatientID: 0, IsRetail: 0 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            if (data.d != "") {
                    ...
                    if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                        ...
                        if (obj.length > 0) {
                            ...
                            for (var index = 0; index < obj.length; index++) {
                                ...
                                table += "<td style='text-align:center;'><a href='#' id=" + obj[index].SalesReturnID + " class='einvoice' invoice='" + obj[index].ReturnNo + "_" + obj[index].Customer.CustomerName + "' title='E-Invoice JSON format'><i class='fa fa-file-code-o text-black'></i></a></td>";
...
function EInvoice_Export(id, invoice) {
    ...
    $.ajax({
        ...
        url: "WebServices/VHMSService.svc/GetSalesReturnJsonHSNFormat",
        data: JSON.stringify({ ID: id }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
...
$("#btnSave,#btnUpdate").click(function () {
    ...
    ObjSalesReturn.ACK_No = $("#txtACKNo").val();
    ObjSalesReturn.IRN_No = $("#txtIRNNo").val();
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            ...
                            $("#txtACKNo").val(obj.ACK_No);
                            $("#txtIRNNo").val(obj.IRN_No);
