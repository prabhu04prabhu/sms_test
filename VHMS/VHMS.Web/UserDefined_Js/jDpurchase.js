        ...
        for (var i = 0; i < gOPBillingList.length; i++) {
            if (gOPBillingList[i].StatusFlag != "D") {
                if ((gOPBillingList[i].Product.ProductID == $("#ddlProductName").val()) && (gOPBillingList[i].Rate == parseFloat($("#txtRate").val())) && (gOPBillingList[i].Tax.TaxID == $("#ddlTax").val()) && (gOPBillingList[i].DiscountPercentage == parseFloat($("#txtDisPer").val()))) {
                    gOPBillingList[i].Quantity = gOPBillingList[i].Quantity + parseInt($("#txtQuantity").val());
...
function GetRecord() {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ iSupplierID: $("#ddlCategoryName").val(), BillType: 0, DC: 0 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            if (data.d != "") {
...
function GetSearchRecord(iDetails) {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ ID: iDetails, BillType: 0, DC: 0 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
...
function EditRecord(id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ ID: id, BillType: 0}),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
