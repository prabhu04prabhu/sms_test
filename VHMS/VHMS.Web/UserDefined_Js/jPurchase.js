            ...
            if (data.d != "") {
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                        ...
                        if (obj.length > 0) {
                            $("#ddlTransport").append('<option value="' + '0' + '">' + '--Select Transport--' + '</option>');
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                        ...
                        if (obj.length > 0) {
                            ...
                            for (var index = 0; index < obj.length; index++) {
                                if (obj[index].IsActive)
                                    $(sControlName).append("<option value='" + obj[index].UserID + "'>" + obj[index].EmployeeCode + '/' + obj[index].EmployeeName + "</option>");
                            }
                        }
                        dProgress(false);
                    }
...
$("#btnAddMagazine,#btnUpdateMagazine").click(function () {
    ...
    if ($("#hdnPurchaseTransID").val() > 0)
        CheckdeleteStockByProductID($("#hdnPurchaseTransID").val(), $("#ddlProductName").val(), parseFloat($("#txtQuantity").val()));
