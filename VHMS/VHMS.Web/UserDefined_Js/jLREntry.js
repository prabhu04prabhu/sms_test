...
$(function () {
    ...
    $("#txtDeliveryDate,#txtLRDate").attr("data-link-format", "dd/MM/yyyy");

    $("#txtDeliveryDate,#txtLRDate").datetimepicker({
        pickTime: false,
        useCurrent: true,
        format: 'DD/MM/YYYY'
    });
...
$("#btnSave,#btnUpdate").click(function () {
    ...
    ObjOPBilling.sAWB_Date = $("#txtLRDate").val().trim();
                    ...
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            ...
                            if (Message.match(/#LR_No#/))
                                Message = Message.replace("#LR_No#", obj.AWBNo);
                            if (Message.match(/#LR_Date#/))
                                Message = Message.replace("#LR_Date#", obj.sAWB_Date);
