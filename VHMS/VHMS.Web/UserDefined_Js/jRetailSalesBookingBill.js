                        ...
                        if (obj.length > 0) {
                            ...
                            for (var index = 0; index < obj.length; index++) {
                                if (obj[index].IsActive == "1") {
                                    ...
                                    table += "<td style='text-align:center;'><a href='#' id=" + obj[index].SalesEntryID + " class='Address' title='Click here to Address Print'><i class='fa fa-address-card'></i></a></td>";
...
function GetSearchRecord(iDetails) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/SearchSalesEntryBokingBill",
...
$("#btnSave,#btnUpdate").click(function () {
    ...
    ObjOPBilling.ImagePath1 = $("[id*=imgUpload1_view]").attr("src");
    ObjOPBilling.ImagePath2 = $("[id*=imgUpload2_view]").attr("src");
    ObjOPBilling.ImagePath3 = $("[id*=imgUpload3_view]").attr("src");
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            ...
                            $("[id*=imgUpload1_view]").attr("src", obj.ImagePath1);
                            $("[id*=imgUpload2_view]").css("visibility", "visible");
                            $("[id*=imgUpload2_view]").attr("src", obj.ImagePath2);
                            $("[id*=imgUpload3_view]").css("visibility", "visible");
                            $("[id*=imgUpload3_view]").attr("src", obj.ImagePath3);
