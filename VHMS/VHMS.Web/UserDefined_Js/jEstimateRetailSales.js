...
$(function () {
    ...
    if ($.cookie("OPBilling") != undefined) {
        ...
        if (_Tfunctionality == "AddNewOPBilling") {
            ...
            GetReceivedEstimateSalesEntry(parseInt($.cookie("EstimateSalesEntryID")));
            $("#hdnEstimateSalesEntryID").val(parseInt($.cookie("EstimateSalesEntryID")));
        }
        $.cookie("OPBilling", null);
        $.cookie("EstimateSalesEntryID", null);
    }
    $("#divCardDetails").hide();
    pLoadingSetup(true);
    GetSettings();
            ...
            if (data.d != "") {
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            $("#hdnviewmargin").val(obj.MarginView);
                            if (obj.MarginView)
                                $(".displayMargin").show();
                            else
                                $(".displayMargin").hide();
...
$("#btnAddNew").click(function () {
    ...
    $("#btnAddNew").hide();
    $("#btnList").show();
    $("#hdnEstimateSalesEntryID").val("0");
    $("#hdnERetailSalesID").val("0");
    $("#txtPasswords").val("");
    $("#btnAddMagazine").show();
    $("#btnUpdateMagazine").hide();
    $("#btnAddExchange").show();
...
$("#txtAdditionalDiscountAmount").change(function () {
    var ID = parseFloat($("#txtAdditionalDiscountAmount").val());
...
function calculateAdditionalDiscount() {
    $("#txtDiscountAmount").val(parseFloat($("#hdnDiscountAmount").val()) - parseFloat($("#hdnAddDiscountAmount").val()));
    ...
    $("#txtDiscountPercent").val((parseFloat(iBillingDiscount) * 100 / parseFloat(iOPBillingAmount)).toFixed(5));
    ...
    var DiscountTrans = parseFloat($("#txtDisPer").val());
    if (isNaN(DiscountTrans)) DiscountTrans = 0;
    for (var i = 0; i < gOPBillingList.length; i++) {
        if (gOPBillingList[i].StatusFlag != "D") {
            gOPBillingList[i].DiscountPercentage = DiscountTrans;
...
$("#txtExchangeBillNo").blur(function () {
    if ($("#txtExchangeBillNo").val().length > 0) {
        GetEstimateSalesReturnDetails($("#txtExchangeBillNo").val());
    }
});
...
$("#ddlExchangeProductName").change(function () {
    ...
    if ($("#ddlExchangeProductName").val() > 0) {
        ...
        for (var i = 0; i < gEstimateSalesReturnList.length; i++) {
            if (gEstimateSalesReturnList[i].Product.ProductID == ProdID) {
                $("#hdnExchangeCode").val(gEstimateSalesReturnList[i].Product.SMSCode);
                $("#txtExchangeQuantity").val(0);
                $("#txtExchangeRate").val(gEstimateSalesReturnList[i].Rate);
                $("#hdnExchangeTaxID").val(gEstimateSalesReturnList[i].Tax.TaxID);
                $("#hdnExchangeTaxPercent").val(gEstimateSalesReturnList[i].Tax.TaxPercentage);
                $("#hdnExchangeCGSTPercent").val(gEstimateSalesReturnList[i].Tax.CGSTPercent);
                $("#hdnExchangeSGSTPercent").val(gEstimateSalesReturnList[i].Tax.SGSTPercent);
                $("#hdnExchangeIGSTPercent").val(gEstimateSalesReturnList[i].Tax.IGSTPercent);
                $("#txtExchangeDisPer").val(gEstimateSalesReturnList[i].DiscountPercentage);
                $("#hdnExchangeBarcode").val(gEstimateSalesReturnList[i].Barcode);
                $("#hdnPreQtyID").val(gEstimateSalesReturnList[i].Quantity);
...
function GetCustomerByCode(ddlname) {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ ID: $("#txtMobileNo").val(), Type: 'Retail' }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
...
$("#btnAddPayment,#btnUpdatePayment").click(function () {
    ...
    if (this.id == "btnAddPayment") {
        ...
        if ($("#hdnEstimateSalesEntryID").val() > 0) {
            ObjData.StatusFlag = "U";
            ObjData.EstimateSalesEntryID = $("#hdnEstimateSalesEntryID").val();
        }
        else {
            ObjData.StatusFlag = "I";
            ObjData.EstimateSalesEntryID = 0;
        }
...
function Bind_PaymentByID(ID, data) {
    ...
    for (var i = 0; i < data.length; i++) {
        if (data[i].sNO == ID) {
            ...
            $("#hdnEstimateSalesEntryID").val(data[i].EstimateSalesEntryID);
...
function Update_Payment(oData) {
    for (var i = 0; i < gPaymentList.length; i++) {
        if (gPaymentList[i].sNO == oData.sNO) {
            gPaymentList[i].EstimateSalesEntryID = oData.EstimateSalesEntryID;
...
$("#btnAddMagazine,#btnUpdateMagazine").click(function () {
    ...
    if (this.id == "btnAddMagazine" || $("#hdnEstimateSalesEntryID").val() == 0) {
...
function Update_OPBilling(oData) {
    for (var i = 0; i < gOPBillingList.length; i++) {
        if (gOPBillingList[i].sNO == oData.sNO) {
            gOPBillingList[i].EstimateSalesEntryID = oData.EstimateSalesEntryID;
            var oProduct = new Object();
...
$("#btnAddExchange,#btnUpdateExchange").click(function () {
    ...
    CalculateAmount();
    ClearEstimateSalesReturnFields();
...
function Bind_ExchangeByID(ID, data) {
    ...
    for (var i = 0; i < data.length; i++) {
        if (data[i].sNO == ID) {
            ...
            $("#EstimateSalesEntryID").val(data[i].EstimateSalesEntryID);
...
function Update_Exchange(oData) {
    for (var i = 0; i < gExchangeList.length; i++) {
        if (gExchangeList[i].sNO == oData.sNO) {
            gExchangeList[i].EstimateSalesReturnID = oData.EstimateSalesReturnID;
            var oProduct = new Object();
            oProduct.ProductID = oData.Product.ProductID;
            oProduct.ProductName = oData.Product.ProductName;
            gExchangeList[i].Product = oProduct;
            gExchangeList[i].EstimateSalesEntryTransID = oData.EstimateSalesEntryTransID;
...
function ClearEstimateSalesReturnFields() {
    $("#btnAddExchange").show();
    $("#btnUpdateExchange").hide();
...
function GetProductDetails(id, value, SID,iSMSCode) {
    dProgress(true);
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetProductDetailsEstimateBySMSCoode",
        data: JSON.stringify({ ID: id, type: value, SupplierID: SID, iSMSCode: iSMSCode }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
                        ...
                        if (obj != null) {
                            ...
                            if (obj.length > 0) {
                                ...
                                for (var i = 0; i < obj.length; i++) {
                                    sTable = "<tr><td id='" + obj[i].PK_EstimateSalesEntryTransID + "'>" + sCount + "</td>";
...
function GetRecord() {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetTopEstimateSalesEntry",
                    ...
                    if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                        ...
                        if (obj.length > 0) {
                                ...
                                if (obj[index].IsActive == "1") {
                                    ...
                                    if (obj[index].BalanceAmount > 0) {
                                        if (obj[index].DueDays == obj[index].Customer.Days)
                                            table += "<tr style='background-color:#d9f7927a;' id='" + obj[index].EstimateSalesEntryID + "'>";
                                        else
                                            table += "<tr id='" + obj[index].EstimateSalesEntryID + "'>";
                                    } else
                                        table += "<tr style='background-color:#f1c6ad;' id='" + obj[index].EstimateSalesEntryID + "'>";
                                    table += "<td>" + (index + 1) + "</td>";
                                    ...
                                    if ($("#hdnviewmargin").val() == "true")
                                        table += "<td class='displayMargin'>" + obj[index].MarginPercent + "</td>";
                                    else
                                        table += "<td style='display:none'>" + obj[index].MarginPercent + "</td>";
                                    if (obj[index].SalesConverted == "1")
                                        { TypeStatus = "<span class='label label-success'>Converted</span>"; }
                                    else
                                        { TypeStatus = "<span class='label label-danger'>Pending</span>"; }
                                    table += "<td>" + TypeStatus + "</td>";

                                    if (ActionView == "1") { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].EstimateSalesEntryID + " class='View' title='Click here to View'><i class='fa fa-lg fa-clone text-yellow'/></a></td>"; }
                                    else { table += "<td></td>"; }

                                    if (ActionUpdate == "1") { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].EstimateSalesEntryID + " class='Edit' title='Click here to Edit'><i class='fa fa-lg fa-edit'/></a></td>"; }
                                    else { table += "<td></td>"; }

                                    if (ActionDelete == "1") { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].EstimateSalesEntryID + " class='Delete' title='Click here to Cancel'><i class='fa fa-lg fa-times-circle text-red'/></a></td>"; }
                                    else { table += "<td></td>"; }

                                    table += "<td style='text-align:center;'><a href='#' id=" + obj[index].EstimateSalesEntryID + " class='Print' title='Click here to Print'><i class='fa fa-print text-green'></i></a></td>";
                            ...
                            $(".Print").click(function () {
                                SetSessionValue("EstimateSalesEntryID", parseInt($(this).parent().parent()[0].id));
                                var myWindow = window.open("PrintEstimateRetailsalesEntry.aspx", "MsgWindow");
                            });
                            $(".Address").click(function () {
                                SetSessionValue("EstimateSalesID", $(this).attr('Accountno'));
...
function GetSearchRecord(iDetails) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/SearchEstimateSalesEntry",
        data: JSON.stringify({ ID: iDetails, IsRetail: 1 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
                            ...
                            for (var index = 0; index < obj.length; index++) {
                                if (obj[index].IsActive == "1") {
                                    ...
                                    if (obj[index].BalanceAmount > 0) {
                                        ...
                                        table += "<tr style='background-color:#f1c6ad;' id='" + obj[index].EstimateSalesEntryID + "'>";
                                    // var table = "<tr id='" + obj[index].EstimateSalesEntryID + "'>";
                                    table += "<td>" + (index + 1) + "</td>";
                                    table += "<td>" + obj[index].InvoiceNo + "</td>";
                                    table += "<td>" + obj[index].sInvoiceDate + "</td>";
                                    table += "<td>" + obj[index].Customer.CustomerName + "</td>";
                                    ...
                                    //if (ActionView == "1")
                                    //{ table += "<td style='text-align:center;'><a href='#' id=" + obj[index].EstimateSalesEntryID + " class='View' title='Click here to View'><i class='fa fa-lg fa-clone text-yellow'/></a></td>"; }
                                    //else
                                    //{ table += "<td></td>"; }
                                    ...
                                    table += "<td style='text-align:center;'><a href='#' id=" + obj[index].EstimateSalesEntryID + " class='Print' title='Click here to Print RSE'></i><i class='fa fa-print text-green'/></a></td>";
...
$("#btnSave,#btnUpdate").click(function () {
    ...
    ObjOPBilling.EstimateSalesEntryID = 0;
    ObjOPBilling.InvoiceNo = $("#txtBillNo").val().trim();
    ObjOPBilling.sInvoiceDate = $("#txtBillDate").val().trim();
    ObjOPBilling.EstimateSalesEntryTrans = gOPBillingList;
    ObjOPBilling.EstimateSalesExchangeTrans = gExchangeList;
    ...
    var ObjEstimateSalesOrder = new Object();
    ObjEstimateSalesOrder.EstimateSalesOrderID = 0;
    ObjOPBilling.EstimateSalesOrder = ObjEstimateSalesOrder;
    ...
    ObjOPBilling.EstimateSalesPoints = $("#txtSalesPoints").val().trim();
    ObjOPBilling.EWayNo = "";
    ObjOPBilling.LRNo = "";
    ...
    if ($("#hdnERetailSalesID").val() > 0) {
        ObjOPBilling.EstimateSalesEntryID = $("#hdnERetailSalesID").val();
        gOPBillingList.EstimateSalesEntryID = ObjOPBilling.EstimateSalesEntryID;
        ...
        sMethodName = "UpdateEstimateSalesEntry";
    }
    else {
        sMethodName = "AddEstimateSalesEntry";
        ObjOPBilling.EstimateSalesEntryID = 0;
            ...
            if (data.d != "") {
                ...
                if (objResponse.Status == "Success") {
                    ...
                    if (objResponse.Value > 0) {
                        ...
                        $("#divTab").show();                        
                        $("#divOPBilling").hide();
                        if (sMethodName == "AddEstimateSalesEntry") {
                            $.jGrowl("Added Successfully", { sticky: false, theme: 'success', life: jGrowlLife });
                            $("#hdnEstimateSalesEntryID").val(objResponse.Value);
                            EditRecord($("#hdnEstimateSalesEntryID").val());
                            $("#btnSave").hide();
                            $("#btnUpdate").hide();
                            $("#btnConvert").show();   
                            $("#btnPrintbill").show();
                            //SetSessionValue("EstimateSalesEntryID", $("#hdnEstimateSalesEntryID").val());
                            //var myWindow = window.open("PrintRetailsalesEntry.aspx", "MsgWindow");
                            $("#btnAddMagazine").hide();
                            $("#btnUpdateMagazine").hide();
                            //SetSessionValue("EstimateSalesEntryID", $("#hdnEstimateSalesEntryID").val());
                            //var myWindow = window.open("PrintEstimateSalesEntryInvoice.aspx", "MsgWindow");
                        }
                        else if (sMethodName == "UpdateEstimateSalesEntry") {
...
$("#btnConvert").click(function () {
    ...
    if ($("#txtOtherPassword").val().trim() == "" || $("#txtOtherPassword").val().trim() == undefined || $("#txtOtherPassword").val().trim() != $("#hdRS").val()) {
        $.jGrowl("Please enter Valid Password to convert", { sticky: false, theme: 'warning', life: jGrowlLife });
    ...
    var iOPBillingAmount = 0; var iProductname = ""; var istockcnt = 0;
    for (var i = 0; i < gOPBillingList.length; i++) {
        if (gOPBillingList[i].StatusFlag != "D") {
            iOPBillingAmount = iOPBillingAmount + 1;
            ...
            $.ajax({
                type: "POST",
                url: "WebServices/VHMSService.svc/GetStockByID",
                data: JSON.stringify({ ID: gOPBillingList[i].Product.ProductID }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (data) {
            ...
            if (StockValue < gOPBillingList[i].Quantity) {
                iProductname = iProductname + gOPBillingList[i].SNo + " ( " + gOPBillingList[i].Product.SMSCode + " ) " + "" + gOPBillingList[i].Product.ProductName + ", ";
                istockcnt++;
            }
        }
    }
    if (istockcnt > 0) {
        $.jGrowl("Stock Not Available for " + iProductname, { sticky: true, theme: 'danger', life: jGrowlLife });
        return false;
    }
    if (iOPBillingAmount <= 0) {
        $.jGrowl("No Product has been added", { sticky: false, theme: 'warning', life: jGrowlLife });
    ...
    for (var i = 0; i < gOPBillingList.length; i++) {
        gOPBillingList[i].SalesEntryTransID = 0;
        gOPBillingList[i].SalesEntryID = 0;
        if (gOPBillingList[i].StatusFlag != "D") {
            iOPBillingAmount = iOPBillingAmount + 1;
            gOPBillingList[i].StatusFlag = "I";
        }
    }
    var d = new Date();
    ...
    var BillDate = (day < 10 ? '0' : '') + day + '/' + (month < 10 ? '0' : '') + month + '/' + d.getFullYear();
    var ObjOPBilling = new Object();

    ObjOPBilling.EstimateSalesEntryID = 0;
    ObjOPBilling.InvoiceNo = $("#txtBillNo").val().trim();
    ObjOPBilling.sInvoiceDate = BillDate;
    ...
    UpdateEstimateSalesStatus($("#hdnERetailSalesID").val());
   
    SaveSalesEntry(ObjOPBilling, sMethodName);
  
});

function UpdateEstimateSalesStatus(id) {
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/UpdateEstimateSalesStatus",
        data: JSON.stringify({ ID: id }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
...
function SaveSalesEntry(ObjOPBilling, sMethodName) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.d != "") {
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value > 0) {
                        $.jGrowl("Estimate bill converted to Sales bill Successfully", { sticky: false, theme: 'success', life: jGrowlLife });
                        ClearOPBillingTab();
                        GetRecord();
                        $("#btnAddNew").show();
                        $("#btnList").hide();
                        ...
                        $("#secHeader").removeClass('hidden');
                        $("#divOPBilling").hide();
                        var myWindow = window.open("frmRetailSales.aspx", "_self");
                    }
                }
                else if (objResponse.Status == "Error") {
                    if (objResponse.Value == "0") {
...
function EditRecord(id) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/GetEstimateSalesEntryByID",
        data: JSON.stringify({ ID: id, IsRetail: 1 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
                ...
                if (objResponse.Status == "Success") {
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            ...
                            $("#hdnERetailSalesID").val(obj.EstimateSalesEntryID);
                            $("#hdnEstimateSalesEntryID").val(obj.EstimateSalesEntryID);
                            ...
                            $("#txtEstimateSalesPoints").val(obj.EstimateSalesPoints);
                           ...
                           // $("#btnAddMagazine,#btnAddExchange").hide();
                            gOPBillingList = [];
                            var ObjProduct = obj.EstimateSalesEntryTrans;
                            for (var index = 0; index < ObjProduct.length; index++) {
                                var objTemp = new Object();
                                objTemp.sNO = index + 1;
                                objTemp.SNo = objTemp.sNO;
                                ...
                                objTemp.EstimateSalesEntryTransID = ObjProduct[index].EstimateSalesEntryTransID;
                                objTemp.EstimateSalesEntryID = ObjProduct[index].EstimateSalesEntryID;
                            ...
                            //gExchangeList = [];
                            //var ObjProduct = obj.EstimateSalesExchangeTrans;
                            //for (var index = 0; index < ObjProduct.length; index++) {
                            //    var objTemp = new Object();
                            //    objTemp.sNO = index + 1;
                            //    objTemp.SNo = objTemp.sNO;
...
function DeleteRecord(id, Reason) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/VHMSService.svc/DeleteEstimateSalesEntry",
