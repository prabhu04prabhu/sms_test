                    ...
                    if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                        ...
                        if (obj != null) {
                            ...
                            for (var index = 0; index < ObjProduct.length; index++) {
                                ...
                                $("#ddlShippingAddress").append("<option value='" + ObjProduct[index].ShippingAddressID + "'>" + ObjProduct[index].BranchName + " - " + ObjProduct[index].Place + " - " + ObjProduct[index].Address + "</option>");
                            }
...
$("#btnAddMagazine,#btnUpdateMagazine").click(function () {
    ...
    if ($("#hdnSalesEntryID").val() == 0) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({ ID: $("#ddlProductName").val(), transaction_id: $("#hdnSalesEntryID").val(), type: "S" }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            success: function (data) {
...
function GetRecord() {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ PublisherID: 0, IsRetail: 0, IsYarnBill: 0 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            if (data.d != "") {
                        ...
                        if (obj.length > 0) {
                            ...
                            for (var index = 0; index < obj.length; index++) {
                                if (obj[index].IsActive == "1") {
                                    ...
                                    table += "<td>" + obj[index].NoofBags + "</td>";
                                    ...
                                    table += "<td style='text-align:center;'><a href='#' id=" + obj[index].SalesEntryID + " class='einvoice' invoice='" + obj[index].InvoiceNo + "_" + obj[index].Customer.CustomerName + "' title='E-Invoice JSON format'><i class='fa fa-file-code-o text-black'></i></a></td>";
...
function GetLastSalesEntryByID() {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ ID: $("#hdnSalesID").val(), IsRetail: 0, IsYarnBill: 0 }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function (data) {
...
$("#btnSave,#btnUpdate").click(function () {
    ...
    ObjOPBilling.Order_No = $("#txtOrderNo").val().trim();
