...
public partial class frmBankStatement : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        if (Convert.ToInt32(ddlCustomer.SelectedValue) > 0)
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Select Account');", true);
    }
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintBankStatement(txtDOB.Text, txtDOR.Text, ddlCustomer.SelectedValue);
        try
        {
            ...
            if (dsReportData.tLedger.Rows.Count > 0)
            {
                ...
                foreach (ReportDataSet.tLedgerRow drtJobCardRow in dsReportData.tLedger)
                {
                    ...
                    TableHTML += "<table cellpadding='0' cellspacing='0' ><thead><tr  colspan='12'><th  style='text-align:center;'>Account Statement</th></tr></thead></table>";
                    TableHTML += "<table cellpadding='0' cellspacing='0'><thead>";
                    TableHTML += "<tr><td><b>Mr./Ms." + drtJobCardRow.LedgerName + "</b></td><td></td></tr>";
                    TableHTML += "<br/>";
                    TableHTML += "</thead></table>";
                    TableHTML += "<table cellpadding='0' cellspacing='0' class='border_details' ><thead>";
                    TableHTML += "<tr><th style='width:15%;'><b>&nbsp Date</b></th><th style='width:15%;'><b>Voucher No</b></th><th style='width:20%;'><b>Type</b></th><th style='width:30%;'><b>Particulars</b></th></th><th style='width:10%;text-align:right'><b>Debit(Rs.)</b></th><th style='width:10%;text-align:right'><b>Credit(Rs.)</b></th></tr></thead>";
                    ...
                    if (dsReportData.tBankStatement.Rows.Count > 0)
                    {
                        ...
                        foreach (ReportDataSet.tBankStatementRow drtJobCardComplaintsRow in dsReportData.tBankStatement)
                        {
                            ...
                            string VDate = "", vNo = "", Particulars = "", TransactionType = "";
                            ...
                            if (!drtJobCardComplaintsRow.IsTransactionTypeNull())
                                TransactionType = drtJobCardComplaintsRow.TransactionType;
                            if (!drtJobCardComplaintsRow.IsParticularsNull())
                                Particulars = drtJobCardComplaintsRow.Particulars;

                            TableHTML += "<tr><td>&nbsp &nbsp" + VDate + "</td><td>" + vNo + "</td><td>" + TransactionType + "</td><td>" + Particulars + "</td><td  style='text-align:right'> " + drtJobCardComplaintsRow.Debit + "</td><td  style='text-align:right'>" + drtJobCardComplaintsRow.Credit + "</td></tr>";
                            sno++;
                        }
                    }
