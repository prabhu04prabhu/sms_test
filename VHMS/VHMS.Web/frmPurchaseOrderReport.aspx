<%@ Page Title="Purchase Order Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPurchaseOrderReport.aspx.cs" Inherits="frmPurchaseOrderReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Purchase Order Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Purchase Order Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Purchase Order Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_PurchaseOrderTransID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Date" ReadOnly="true" DataField="PurchaseOrderDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="PO.No" ReadOnly="true" DataField="PurchaseOrderNo" />
                                ...
                                <asp:TemplateField HeaderText="Quantity">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotal" runat="server" Style="width: 10px;" Text='<%# ""+Eval("Quantity").ToString()%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
