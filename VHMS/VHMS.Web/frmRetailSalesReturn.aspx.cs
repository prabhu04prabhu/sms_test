...
public partial class frmRetailSalesReturn : BaseConfig
{
    ...
    public static string saveimage(string data)
    {
        ...
        String path = HttpContext.Current.Server.MapPath("~/images/Documents/RetailSalesReturn");
        string imgPath = Path.Combine(path, imageName);
        File.WriteAllBytes(imgPath, imgarr);
        return "images/Documents/RetailSalesReturn/" + imageName;
    }
}