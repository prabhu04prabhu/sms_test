<%@ Page Title="Retail Sales Booking Bill" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmRetailSalesBookingBill.aspx.cs" Inherits="frmRetailSalesBookingBill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divBillDate">
                            <label>
                                Booking Date</label><span class="text-danger">*</span>
                    ...
                    <div class="box box-primary box-solid">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-1" id="divBarcode" style="margin-left: -21px;">
                                    <label>
                                ...
                                <div class="form-group col-md-2" id="divCode" style="margin-left: -21px;">
                                    <label>
                                        SMSCode / ProductCode</label><span class="text-danger">*</span>
                                ...
                                <div class="form-group col-md-3" id="divProductName" style="margin-left: -21px;">
                                    ...
                                    <div id="divSelectProductName">
                                        <select id="ddlProductName" class="form-control select2" data-placeholder="Select Product Name" tabindex="11"></select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-1" id="divTaxTrans" style="margin-left: -21px;">
                                    ...
                                    <select id="ddlTax" class="form-control select2" data-placeholder="Select Tax " tabindex="15"></select>
                                </div>
                                <div class="form-group col-md-1" id="divTaxAmt" style="display: none">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtTaxAmt" placeholder="Tax Amt"
                                        maxlength="15" tabindex="-1" onkeypress="return IsNumeric(event)" readonly="true" />
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divGift">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divSalesPoints">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divNotes">
                                    ...
                                    <input type="text" class="form-control" id="txtNotes" placeholder="Notes"
                                        maxlength="16" tabindex="38" autocomplete="off" />
                                </div>
                                <div class="form-group col-md-1 pull-right">
                                    <div class="margin">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <img src="" id="imgUpload1_view" alt="" style="width: 280px;" />
                        </div>
                        <div class="form-group col-md-3">
                            <label>
                                Image 2</label>
                            ...
                            <img src="" id="imgUpload2_view" alt="" style="width: 280px;" />
                        </div>
                        <div class="form-group col-md-3">
                            <label>
                                Image 3</label>
                            ...
                            <img src="" id="imgUpload3_view" alt="" style="width: 280px;" />
                        </div>
                        <div class="form-group col-md-1" style="text-align: right">
                            <label>
                                Bill Status</label>
                        </div>
                        <div class="form-group col-md-2" id="divBillStatus">
                            <select id="ddlBillStatus" class="form-control" tabindex="41">
                        ...
                        <div class="form-group col-md-2" id="divDeliveryDate">
                            <div class="input-group date form_date" data-date-format="dd/MM/yyyy HH:ii P" data-link-field="txtOPBillingDate"
                                data-link-format="dd/MM/yyyy">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar glyphicon glyphicon-calendar"></i>
                                </div>
                                <input type="text" class="form-control pull-right" tabindex="42" id="txtDeliveryDate" readonly />
                            </div>
                        </div>
                        <div class="form-group col-md-8" id="divComments">
                            <label>
                                Comments</label>
                            <textarea id="txtComments" class="form-control" maxlength="1000" tabindex="43" rows="3" aria-autocomplete="none" style="width: 152%"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer clearfix">
                    <button id="btnSave" type="button" class="btn btn-info margin pull-left" tabindex="44">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Save</button>
                    <button id="btnUpdate" type="button" class="btn btn-info margin pull-left" tabindex="45">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Update</button>
                    <button type="button" class="btn btn-danger pull-right" id="btnClose" tabindex="46">
                        <i class="fa fa-close"></i>&nbsp;&nbsp;Close</button>
                    <button id="btnPrintbill" type="button" class="btn btn-info btnPrint margin pull-left" tabindex="47">
                ...
                <div class="modal-body">
                    <div class="form-group" id="divReason">
                        ...
                        <input type="text" class="form-control" id="txtReason" placeholder="Please enter Reason"
                            maxlength="150" tabindex="48" autocomplete="off" />
                    </div>
                    <div class="form-group" id="divPassword">
                        ...
                        <input type="text" class="form-control" id="txtPassword" placeholder="Please enter Password"
                            maxlength="150" tabindex="49" autocomplete="off" />
                    </div>
                    <div class="form-group" id="divID">
                        <label>
                            ID</label><span class="text-danger">*</span>
                        <input type="text" class="form-control" id="txtID"
                            maxlength="150" tabindex="50" />
                    </div>
                </div>
                <div class="modal-footer clearfix">
                    <button type="submit" class="btn btn-info pull-left" id="btnOK" tabindex="54">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;
                                Save</button>
                    <button type="button" class="btn btn-danger pull-right" id="btnCancel" tabindex="52">
    ...
    <div class="modal fade" id="composedetails" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-body">
            <div class="modal-content">
                ...
                <div class="modal-footer clearfix">
                    <button type="button" class="btn btn-danger pull-left" id="btndetailsCancel" tabindex="53">
                        <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
    ...
    <div class="modal fade" id="composeImage" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <img src="" id="imgUpload1" alt="" style="visibility: hidden; display: block; margin-left: auto; margin-right: auto; width: 480px; height: 425px" />
                    </div>
                </div>
                <div class="modal-footer clearfix">
                    <button type="button" class="btn btn-danger pull-left" id="btnImageCancel" tabindex="54">
                        <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6" id="divSearchCode">
                            ...
                            <input type="text" class="form-control TRSearch" id="txtSearchCode" placeholder="Code"
                                maxlength="12" tabindex="54" autocomplete="off" />
                        </div>
                        <div class="form-group col-md-6" id="divProduct">
                            <label>
                                Product</label><span class="text-danger">*</span>
                            <div id="divSelectProduct">
                                <select id="ddlProduct" class="form-control select2" data-placeholder="Select Product Name" tabindex="56"></select>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6" id="divWholeSalePrice">
                            ...
                            <input type="text" class="form-control TRSearch" id="txtWholeSalePrice" placeholder="Rate"
                                maxlength="12" tabindex="57" readonly="true" />
                        </div>
                        <div class="form-group col-md-6" id="divRetailPrice">
                            ...
                            <input type="text" class="form-control TRSearch" id="txtRetailPrice" placeholder="Retail Price"
                                maxlength="12" tabindex="58" readonly="true" />
                        </div>
                        ...
                        <div class="form-group col-md-4" id="divRetailSalePriceA">
                            ...
                            <input type="text" class="form-control TRSearch" id="txtRetailSalePriceA" placeholder="Retail Price A"
                                maxlength="12" tabindex="59" readonly="true" />
                        </div>
                        <div class="form-group col-md-4" id="divRetailSalePriceB">
                            ...
                            <input type="text" class="form-control TRSearch" id="txtRetailSalePriceB" placeholder="Retail Price B"
                                maxlength="12" tabindex="60" readonly="true" />
                        </div>
                        <div class="form-group col-md-4" id="divRetailSalePriceC">
                            ...
                            <input type="text" class="form-control TRSearch" id="txtRetailSalePriceC" placeholder="Retail Price C"
                                maxlength="12" tabindex="61" readonly="true" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer clearfix">
                    <button type="button" class="btn btn-danger pull-left" id="btnRateCancel" tabindex="62">
                        <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
                ...
                <div class="modal-header">
                    ...
                    <div class="form-group" id="divPasswords">
                        ...
                        <input type="text" class="form-control" id="txtPasswords" placeholder="Please enter Password"
                            maxlength="150" tabindex="63" autocomplete="off" />
                    </div>
                </div>
                <div class="modal-footer clearfix" style="text-align: center">
                    <button type="button" class="btn btn-warning" id="btnCloseDialog" tabindex="64">
                        <i class="fa fa-close"></i>&nbsp;&nbsp;
                                OK</button>
                </div>
            </div>
    ...
    <script src="UserDefined_Js/jRetailSalesBookingBill.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jRetailSalesBookingBill.js") %>" type="text/javascript"></script>
