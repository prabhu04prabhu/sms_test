...
public partial class frmNewPatientReport : System.Web.UI.Page
{
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=NewPatientDetails.xls");
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=NewPatientDetails.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintNewPatientDetails(0, txtDOB.Text, txtDOR.Text, Convert.ToInt32(ddlCategory.SelectedValue), ddlHRefer.SelectedItem.Text);
        try
        {
