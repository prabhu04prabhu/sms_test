<%@ Page Title="Prescription Details" Language="C#" MasterPageFile="~/VHMSReportPage.master" 
    AutoEventWireup="true" CodeFile="RepViewPrescriptionDetails.aspx.cs" Inherits="RepViewPrescriptionDetails" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="box box-warning box-solid hidden" id="divDischargeEdit">
                        <div class="box-header with-border">
                            <div class="box-title">
                                <i class="fa fa-print"></i>&nbsp;&nbsp;Prescription Details
                            </div>
                        </div>
                        <div class="box-body">
                            <div class="row">
