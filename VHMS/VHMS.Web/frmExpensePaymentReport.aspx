<%@ Page Title="Expense Payment Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" 
    AutoEventWireup="true" CodeFile="frmExpensePaymentReport.aspx.cs" Inherits="frmExpensePaymentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Expense Payment Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Expense Payment Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Expense Payment Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_ExpensePaymentID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Vouc.No" ReadOnly="true" DataField="VoucherNo" />
                                 <asp:BoundField HeaderText="Entry Dt" ReadOnly="true" DataField="VoucherDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Collection Dt" ReadOnly="true" DataField="CollectionDate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Party" ReadOnly="true" DataField="SupplierName" />
                              <%--  <asp:BoundField HeaderText="BillNos" ReadOnly="true" DataField="BillNos" />--%>
                                  <asp:TemplateField HeaderText="BillNos">
                                    <ItemTemplate>
                                       <asp:Label ID="lblBillCount" runat="server"></asp:Label>
                                        <br />
                                    </ItemTemplate>
                                </asp:TemplateField>
<%--                                <asp:BoundField HeaderText="BillDates" ReadOnly="true" DataField="BillDates" DataFormatString="{0:dd/MM/yyyy}" />--%>
                                <asp:BoundField HeaderText="BankName" ReadOnly="true" DataField="BankName" />
                                <asp:BoundField HeaderText="Charges" ReadOnly="true" DataField="OtherDiscount" />
                                <asp:BoundField HeaderText="Disc.Amt" ReadOnly="true" DataField="Discount_Amount" />
    ...
    <script type="text/javascript">
        document.onkeydown = function () {
            if (event.keyCode == 113) {
                var myWindow = window.open("frmDPaymentReport.aspx", "_self");
            }
