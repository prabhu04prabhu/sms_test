...
public partial class frmVendorReport : System.Web.UI.Page
{
    ...
    //{
    //    Collection<VHMS.Entity.Vendor> ObjList = new Collection<VHMS.Entity.Vendor>();
    //    ObjList = VHMS.DataAccess.Vendor.GetVendor();
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintVendor();
        try
        {
            if (dsData.Tables.Count > 0)
            {
                dsData.Tables[0].TableName = "tVendor";
        ...
        {
            sException = "frmPrintVendor | " + ex.ToString();
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=Vendor.xls");
