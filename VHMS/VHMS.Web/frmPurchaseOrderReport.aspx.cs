...
public partial class frmPurchaseOrderReport : System.Web.UI.Page
{
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintPurchaseOrder(txtDOB.Text, txtDOR.Text, ddlProduct.SelectedValue, ddlCategory.SelectedValue, ddlSubCategory.SelectedValue, ddlSupplier.SelectedValue);
        try
        {
            if (dsData.Tables.Count > 0)
            {
                dsData.Tables[0].TableName = "tPurchaseOrderTrans";
