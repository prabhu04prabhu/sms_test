<%@ Page Title="Payment Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPaymentReport.aspx.cs" Inherits="frmPaymentReport" %>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Payment Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_PaymentID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Supp.Name" ReadOnly="true" DataField="SupplierName" />
