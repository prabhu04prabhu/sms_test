<%@ Page Title="TDS Payment" Language="C#" MasterPageFile="~/VHMSMasterPage.master"
    AutoEventWireup="true" CodeFile="frmTDSPayment.aspx.cs" Inherits="frmTDSPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3" id="divCustomer">
                            <label>
                                Customer Name</label>
                            <select id="ddlCustomerName" class="form-control select2" data-placeholder="Select Customer Name" tabindex="1"></select>
                        </div>
                        ...
                        <div class="form-group col-md-2" id="divSlipDate">
                            ...
                            <div class="input-group date form_date" data-date-format="dd/MM/yyyy HH:ii P" data-link-field="txtSlipDate"
                                ...
                                <input type="text" class="form-control pull-right" tabindex="3" id="txtSlipDate" readonly="true" />
                            </div>
                        </div>
                        <div class="form-group col-md-2" id="divManualPayment">
                            <label>
                                Type</label>
                            <select id="ddlManualPayment" class="form-control select2" data-placeholder="Select Type" tabindex="3">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divOldSalesInvoice">
                                    <label>
                                        Old Sales Invoice No</label><span class="text-danger">*</span>
                                    <div id="divSelectOldProductName">
                                        <select id="ddlOldSalesInvoice" class="form-control select2" data-placeholder="Select SalesInvoice" tabindex="4"></select>
                                    </div>
                                </div>
                                <div class="form-group col-md-2" id="divOldSalesTotalAmt">
                                    <label>
                                        Old Sales TotalAmount</label>
                                ...
                                <div class="form-group col-md-2" id="divProductName">
                                    <label>
                                        Adjust Sales Invoice No</label><span class="text-danger">*</span>
                                    <div id="divSelectProductName">
                                        <select id="ddlProductName" class="form-control select2" data-placeholder="Select Adjust Bill" tabindex="5"></select>
                                    </div>
                                </div>
                                <div class="form-group col-md-2" id="divAvailableQty">
                                    <label>
                                        Adjust Sales Total Amt</label>
                                ...
                                <div class="form-group col-md-1"id="divRoundoffTrans">
                                    ...
                                    <input type="text" class="form-control" id="txtRoundoffTrans" placeholder="Roundoff"
                                        maxlength="15" tabindex="7" value="0" autocomplete="off" />
                                </div>
                                <div class="form-group col-md-1" id="divDisPer">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtDisPer" placeholder="TDS Amount"
                                        maxlength="12" onkeypress="return IsNumeric(event)" tabindex="-1" readonly="true" />
                                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-8" id="divAddress">
                            ...
                            <textarea id="txtAddress" class="form-control" maxlength="250" tabindex="10" rows="5" aria-autocomplete="none"></textarea>
                        </div>
                        ...
                        <div class="form-group col-md-2" id="divRoundoff">
                            <input type="text" class="form-control" id="txtRoundoff" placeholder="Roundoff" style="font-size: 104%; font-weight: bold;"
                                maxlength="15" tabindex="11" value="0" autocomplete="off" />
                        </div>
                        <div class="form-group col-md-2">
                    ...
                    <div class="modal-footer clearfix">
                        <button id="btnSave" type="button" class="btn btn-info margin pull-left" tabindex="12">
                            <i class="fa fa-save"></i>&nbsp;&nbsp;Save</button>
                        <button id="btnUpdate" type="button" class="btn btn-info margin pull-left" tabindex="13">
                            <i class="fa fa-save"></i>&nbsp;&nbsp;Update</button>
                        <button type="button" class="btn btn-danger pull-right" id="btnClose" tabindex="14">
                            <i class="fa fa-close"></i>&nbsp;&nbsp;Close</button>
                        <button id="btnPrintbill" type="button" class="btn btn-info btnPrint margin pull-left" tabindex="15">
    ...
    <script src="UserDefined_Js/jTDSPayment.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jTDSPayment.js") %>"
