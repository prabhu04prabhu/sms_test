<%@ Page Title="YarnSalesEntryReturn" Language="C#" MasterPageFile="~/VHMSMasterPage.master"
    AutoEventWireup="true" CodeFile="frmYarnSalesEntryReturn.aspx.cs" Inherits="frmYarnSalesEntryReturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
            ...
            <div class="box box-primary" id="divSalesReturn">
                <div class="box-header with-border">
                    <div class="box-title">YarnSalesReturn Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8" id="divAddress">
                            <label>
                                Comments</label>
                            <textarea id="txtComments" class="form-control" maxlength="255" tabindex="22" rows="3" aria-autocomplete="none" style="width:152%"></textarea>
                        </div>
                    </div>
    ...
    <script src="UserDefined_Js/JSalesReturn.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/JYarnSalesReturn.js") %>"
    ...
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmYarnSalesEntryReturn.aspx") %>';
