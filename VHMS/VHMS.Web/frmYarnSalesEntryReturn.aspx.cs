...
public partial class frmYarnSalesEntryReturn : BaseConfig
{
    protected string UploadFolderPath = "~/images/Documents/YarnSales/";
    ...
    public static string saveimage(string data)
    {
        ...
        String path = HttpContext.Current.Server.MapPath("~/images/Documents/YarnSales");
