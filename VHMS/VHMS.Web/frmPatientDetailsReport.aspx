<%@ Page Title="Patient Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPatientDetailsReport.aspx.cs" Inherits="frmPatientDetailsReport" %>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divCategory">
                                    ...
                                    <asp:DropDownList ID="ddlCategory" AutoPostBack="true" Width="200" Height="30"
                                        OnSelectedIndexChanged="ddlPayment_SelectedIndexChanged" runat="server">
                                        <asp:ListItem Text="All" Value="All"></asp:ListItem>
                                        <asp:ListItem Text="Fertility" Value="Fertility"></asp:ListItem>
                                        <asp:ListItem Text="Gynaecology" Value="Gynaecology"></asp:ListItem>
                                        <asp:ListItem Text="ANC" Value="ANC"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
