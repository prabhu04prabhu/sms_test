<%@ Page Title="Yarn Sales Entry" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmYarnSalesEntry.aspx.cs" Inherits="frmYarnSalesEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
                        ...
                        <div class="box box-warning">
                            <div class="box-body">
                                <div class="form-group" id="divSearchaname">
                                    <label>
                                        Search Yarn Sales records</label><span class="text-danger">*</span>
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">Yarn Sales Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3" id="divShippingAddressName1" style="width: 156px;">
                            <label>
                    ...
                    <div class="box box-primary box-solid">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divProductName" style="margin-left: -21px;">
                                    <label>
                                        Product</label><span class="text-danger">*</span>
                                    <div id="divSelectProductName">
                                        <select id="ddlProductName" class="form-control select2" data-placeholder="Select Product Name" tabindex="7" <%--autocomplete="off" readonly--%>></select>
                                    </div>
                                </div>
                                <div class="form-group col-md-1" id="divBarcode" style="margin-left: -21px;">
                                    ...
                                    <input type="text" class="form-control TRSearch" id="txtBarcode" placeholder="Barcode"
                                        maxlength="12" tabindex="-1" readonly autocomplete="off" />
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8" id="divIRNNo">
                            <input type="text" class="form-control" id="txtIRNNo" placeholder=" IRN No"
                                maxlength="500" tabindex="18" autocomplete="off" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5" id="divACKno">
                            <input type="text" class="form-control" id="txtACKno" placeholder="ACK No"
                                maxlength="500" tabindex="19" autocomplete="off" />
                        </div>
                        <div class="form-group col-md-1" style="text-align: right">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divTransportName">
                            <select id="ddlTransport" class="form-control select2" data-placeholder="Select Transport Name" tabindex="18"></select>
                        </div>
                        <div class="form-group col-md-1">
                            <label>
                        ...
                        <div class="form-group col-md-2" id="divTransportCharge">
                            <input type="text" class="form-control" id="txtTransportCharge" placeholder="Transport Charges" style="font-size: 104%; font-weight: bold;"
                                maxlength="15" tabindex="20" value="0" autocomplete="off" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divNoofBages">
                            <input type="text" class="form-control" id="txtNoofBages" placeholder=" Noof Bages"
                                maxlength="50" tabindex="22" autocomplete="off" />
                        </div>
                        <div class="form-group col-md-1">
                            <label>
                                Narration</label>
                        ...
                        <div class="form-group col-md-2" id="divNarration">
                            <input type="text" class="form-control" id="txtNarration" placeholder="Narration"
                                maxlength="500" tabindex="23" autocomplete="off" />
                        </div>
                    ...
                    <div class="form-group col-md-12" id="divAddress">
                        <label>
                            Notes</label>
                        <textarea id="txtComments" class="form-control" maxlength="255" tabindex="25" rows="3" aria-autocomplete="none" style="width: 101%"></textarea>
                    </div>
                    <div class="row">
                ...
                <div class="row" style="display: none" id="divBank">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2" id="divCardNo">
                            ...
                            <input type="text" class="form-control" id="txtCardNo" placeholder="CardNo"
                                maxlength="16" tabindex="26" style="width: 192px;" onkeypress="return IsNumeric(event)" autocomplete="off" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-9"></div>
                        ...
                        <div class="form-group col-md-2" id="divCardCharges">
                            ...
                            <input type="text" class="form-control" id="txtCardCharges" placeholder="CardCharges"
                                maxlength="15" tabindex="27" value="0" style="width: 192px;" onkeypress="return IsNumeric(event)" autocomplete="off" />
                        </div>
                    </div>
                    <div class="form-group col-md-9"></div>
                    <div class="form-group col-md-1">
                    ...
                    <div class="form-group col-md-2">
                        <select id="ddlBankName" class="form-control select2" data-placeholder="Select Bank Name" tabindex="28"></select>
                    </div>

                </div>

                <div class="modal-footer clearfix">
                    <button id="btnSave" type="button" class="btn btn-info margin pull-left" tabindex="29">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Save</button>
                    <button id="btnUpdate" type="button" class="btn btn-info margin pull-left" tabindex="30">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Update</button>
                    <button type="button" class="btn btn-danger margin pull-right" id="btnClose" tabindex="31">
            ...
            <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" id="divPassword">
                                ...
                                <input type="text" class="form-control" id="txtPassword" placeholder="Please enter Password"
                                    maxlength="150" tabindex="34" autocomplete="off" />
                            </div>
                        ...
                        <div class="modal-footer clearfix">
                            <button type="submit" class="btn btn-info pull-left" id="btnOK" tabindex="36">
                                <i class="fa fa-save"></i>&nbsp;&nbsp;
                                Save</button>
                            <button type="button" class="btn btn-danger pull-right" id="btnCancel" tabindex="37">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix" style="display: none;">
                            <button type="button" class="btn btn-danger pull-left" id="btndetailsCancel" tabindex="38">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="Yarncomposedetails" tabindex="-1" role="dialog" aria-hidden="true" style="margin-top: -25px;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header" style="height: 10px; padding: 0px;">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="Yarnmodal-title"></h4>
                        </div>
                        <div class="modal-body">
                            <div class="table-responsive">
                                <div id="divYarnDetailsList">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer clearfix" style="display: none;">
                            <button type="button" class="btn btn-danger pull-left" id="btnYarndetailsCancel" tabindex="38">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="Allcomposedetails" tabindex="-1" role="dialog" aria-hidden="true" style="margin-top: -25px;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="width: 105%;">
                        ...
                        <div class="modal-footer clearfix" style="display: none;">
                            <button type="button" class="btn btn-danger pull-left" id="btnAlldetailsCancel" tabindex="39">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="composeImage" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-danger pull-left" id="btnImageCancel" tabindex="40">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
            ...
            <div class="modal fade" id="composeRate" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" id="divProduct">
                                    ...
                                    <div id="divSelectProduct">
                                        <select id="ddlProduct" class="form-control select2" data-placeholder="Select Product Name" tabindex="42"></select>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-danger pull-left" id="btnRateCancel" tabindex="49">
                                <i class="fa fa-close"></i>&nbsp;&nbsp;
                                Close</button>
    ...
    <input type="hidden" id="hdnBarcodeID" />
    ...
    <script src="UserDefined_Js/jYarnSalesEntry.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jYarnSalesEntry.js") %>" type="text/javascript"></script>
        ...
        $(document).ready(function () {
            ...
            $("[id$=txtCode]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/frmBarcode.aspx/GetBarcodeCodeYarn") %>',
