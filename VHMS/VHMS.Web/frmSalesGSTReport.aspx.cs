...
public partial class frmSalesGSTReport : System.Web.UI.Page
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=WholeSalesGST.xls");
                Response.Charset = "";
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=WholeSalesGST.pdf");
    ...
    private void LoadReport()
    {
        ...
        dsData = VHMS.DataAccess.VHMSReports.PrintSalesGST(txtDOB.Text, txtDOR.Text, ddluser.Text);
        try
        {
        ...
        {
            sException = "frmPrintSalesGST | " + ex.ToString();
