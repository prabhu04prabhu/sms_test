<%@ Page Title="Purchase Discount Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmPurchaseDiscountReport.aspx.cs" Inherits="frmPurchaseDiscountReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Purchase Discount Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Purchase Discount Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvPurchase" runat="server" Caption="Purchase Discount Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="Pk_PurchaseDiscountID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="DiscountNo" ReadOnly="true" DataField="DiscountNo" /> 
                                <asp:BoundField HeaderText="Entry Date" ReadOnly="true" DataField="CreatedOn" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Discount Date" ReadOnly="true" DataField="DiscountDate" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:BoundField HeaderText="Notes" ReadOnly="true" DataField="Notes" />
                            </Columns>
