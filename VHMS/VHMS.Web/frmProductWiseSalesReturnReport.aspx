<%@ Page Title="Product Wise Sales Return Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmProductWiseSalesReturnReport.aspx.cs" Inherits="frmProductWiseSalesReturnReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Product Wise Sales Return Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Product Wise Sales Return Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divSupplier">
                                    ...
                                    <asp:DropDownList ID="ddlSupplier" OnSelectedIndexChanged="ddlSupplier_SelectedIndexChanged" AutoPostBack="true" Width="200" Height="30" runat="server" CssClass="select2">
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Product Wise Sales Return Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            AutoGenerateColumns="false" GridLines="None" DataKeyNames="PK_SalesReturnTransID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Invoice No" ReadOnly="true" DataField="ReturnNo" />
                                <asp:BoundField HeaderText="Entry Date" ReadOnly="true" DataField="CreatedOn" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Date" ReadOnly="true" DataField="ReturnDate" DataFormatString="{0:dd/MM/yyyy}" />
