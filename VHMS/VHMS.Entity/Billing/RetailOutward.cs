...
namespace VHMS.Entity.Billing
{
    ...
    {
        public int RetailOutwardID { get; set; }
        ...
        public Boolean IsYarnBill { get; set; }
       ...
       // public string CardNo { get; set; }
        ...
        public decimal SalesExchangeAmt { get; set; }
        ...
        public Collection<RetailOutwardTrans> RetailOutwardTrans { get; set; }
       
    }

    public class RetailOutwardTrans
    {
        public int RetailOutwardTransID { get; set; }
        public int RetailOutwardID { get; set; }
    ...
    public class RetailOutwardFilter
    {
    ...
    public class RetailOutwardTransDetails
    {
        public int RetailOutwardTransID { get; set; }
        public int RetailOutwardID { get; set; }
        public decimal Quantity { get; set; }
